...
<%
		...
		BaseJdbcDao baseJdbc=(BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
			...
			String sql = "select jznum,subject,money,payterm,paydate,payway,frozen,blank,text from uf_wkdocuminfo  where requestid='"+requestid+"'";
			...
			String upsql = "update uf_fn_wkdividpay  set creditno='"+AC_DOC_NO+"',creflag='"+FLAG+"',error='"+ERR_MSG+"' where  requestid = '"+requestid+"'";
