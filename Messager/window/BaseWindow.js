...
var para={
		...
		top:'0',
		left:'0',
		logoImg:'images/icon-offline.gif',
		name:'Zdp Window 1',
		canDrag:true
}
...
BaseWindow.prototype._getTemplateClone=function(){
	...
	//alert(this.objWindow.getAttribute("style"));
	//this.objWindow.style.
	//this.objWindow.find(".content").style.cssText="float:left;";
}			
...
BaseWindow.prototype._setOperate=function(){		
	...
	this.objWindow.find(".operate").hover(			
		function () {
			$(this).css("background-image","url('/messager/css/gray/x.gif')");
		}
	);	
	var $this=this;
