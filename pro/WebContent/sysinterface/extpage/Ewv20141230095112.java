package com.eweaver.sysinterface.extclass; 
 ...
 public class Ewv20141230095112 extends EweaverExecutorBase{
 ...
 public void doExecute (Param params) {
    ...
    /* EweaverUser currentuser = BaseContext.getRemoteUser();//获取当前用户对象 
     ...
     String upflowtypesql = "update uf_hr_temploanform  set flowtype = '40285a8f489c17ce0148a12871bb0d9b' where requestid = '"+requestid+"'";
	 ...
	 if(list.size()>0){
		...
		if(feetype.equals("40285a904931f62b01495059a83228fa")) //如果费用类型为出差培训类
		{
			...
			{
				String upsql = "update uf_hr_businesstrip set zjkmark = '40285a8f489c17ce0148ba6c7e7e696c',zjkreq = '"+requestid+"' where requestid = '"+businessreqno+"' ";
				baseJdbc.update(upsql);
            }
			else //如果关联的是外训申请单
			{
				String upsql = "update uf_hr_outlesson  set jkmark = '40285a8f489c17ce0148ba6c7e7e696c',jkreq = '"+requestid+"' where requestid = '"+outtrainreqno+"' ";
				baseJdbc.update(upsql);
			}
		}
	  }//if end
