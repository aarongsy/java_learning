...
public class Ewv20141211090603 extends EweaverExecutorBase{ 
...
public void doExecute (Param params) {
    	...
    	if(list.size()>0){
    		...
    		if(classhour==12 && hours<=4){//12小时的班且请假时数<=4
    			...
    			String upsql = "update uf_hr_classplan set vacation=vacation+to_number('"+hours+"') where objname='"+objname+"' and thedate='"+startdate+"'";
