package com.eweaver.sysinterface.extclass; 
 ...
 public class Ewv20141011094402 extends EweaverExecutorBase{ 
 ...
 public void doExecute (Param params) {
	...
	String sql = "select cardinfoid from uf_hr_certificates where requestid='"+requestid+"'";
	List list = baseJdbc.executeSqlForList(sql);
	if(list.size()>0){
		Map map = (Map)list.get(0);
		String reqid = StringHelper.null2String(map.get("cardinfoid"));

		String upsql="update uf_hr_cardinfo set flowtype='40285a8f489c17ce0148a12871bb0d9b' where requestid='"+reqid+"'";
