...
public class Ewv20141204181124 extends EweaverExecutorBase {
	...
	public void doExecute(Param params) {
		// TODO Auto-generated method stub
	     ...
	     String field1 = params.getParamValueStr("FIELD1");//获取表单中的字段值,字段名参数要大写 		
	     	 ...
	     	 * 
	     	 */
	     	String inqsql = "select a.isself isself,b.deliverdnum,b.cardetailid from uf_lo_loadplan a,uf_lo_loaddetail b where a.requestid=b.requestid and a.isself='40288098276fc2120127704884290210' and a.requestid ='"+requestid+"'";
	        ...
	        if(list.size()>0){
		        ...
		        List list1 = baseJdbc.executeSqlForList(sql1);
			        ...
			        upsql2 = "update uf_lo_loadplan set state='402864d1493b112a01493bfaf09a0005' where requestid='"+requestid+"'";
