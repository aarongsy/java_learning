package com.eweaver.sysinterface.extclass; 
 ...
 public class Ewv20141030143427 extends EweaverExecutorBase{ 
 ...
 public void doExecute (Param params) {
    ...
    BaseJdbcDao baseJdbc=(BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
	 String sql = "select tripno from uf_hr_tripexpense  where requestid='"+requestid+"'";
	...
	// for(int s=0;s<list.size();s++){
		...
		String upsql="update uf_hr_businesstrip set canceltype='40285a8f489c17ce0148ba60c731687c' where requestid = '"+id+"' or requestid = '"+id2+"' or requestid = '"+id3+"'";
