...
import com.eweaver.sysinterface.javacode.EweaverExecutorBase; 
 public class Ewv20141211093252 extends EweaverExecutorBase{ 
...
public void doExecute (Param params) {
    	...
    	BaseJdbcDao baseJdbc = new BaseJdbcDao();
    	...
    	if(list.size()>0){
    		...
    		if(classhour==12 && hours<=4){//12小时的班且请假时数<=4
    			...
    			String upsql = "update uf_hr_classplan set vacation=vacation+to_number('"+Integer.toString(hours)+"') where objname='"+objname+"' and thedate='"+startdate+"'";
