package com.eweaver.sysinterface.extclass; 
 ...
 public class Ewv20140925164206 extends EweaverExecutorBase{ 
 ...
 public void doExecute (Param params) {
	...
	if (list.size()>0)
	{
		...
		{
			sql = "select entryno,reqid from uf_hr_entrysub where requestid='"+requestid+"'";
			...
			if(list2.size()>0){
				for(int s=0;s<list2.size();s++){
					...
					String entryno = StringHelper.null2String(map2.get("entryno"));
					String upsql="update uf_hr_talentpool set marktype='40285a8f489c17ce0148a127f5c80d8d',rqtype='40285a8f489c17ce0148a12871bb0d9b',jobno='"+entryno+"' where requestid='"+reqid+"'";
