...
String sql = reportService.getProjectNumDependState(orgunitid,begindate,enddate);
		...
		<!-- div id="searchctrl" align="right"><a href="javascript:onHiddenShow('searchTable')"><img src="/images/task_up.gif" border="0">&nbsp;<img src="/images/task_down.gif" border="0"></a></div-->
			...
			Iterator it = list.iterator();
				while(it.hasNext()) {
					...
					String state = selectitemService.getSelectitemNameById((String)map.get("objstatus")) ;
%>
