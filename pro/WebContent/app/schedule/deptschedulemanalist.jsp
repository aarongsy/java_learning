 	 ...
 	 <div class="detaildiv">
 	    <div class="maindiv">
 	    	<p>日期：<input type="text" id="date" name="date" value="<%=getdates %>" onclick="WdatePicker()"/>
 	    		<a href="javascript:void(0)" id="newasso" onclick="sousuo()"><span>搜 索</span></a>
	 	    ...
	 	    <table class="maintable" border="0px;" cellpadding="0" cellspacing="0" width="97%">
	 	    	...
	 	    	<tr>
	 	    		...
	 	    		<td style="padding: 4px;">
	 	    			<textarea rows="8" cols="78" id="zidingyi" name="zidingyi" style="overflow: hidden; border: 1px; border-color: #C83E31;border-style: solid;" ></textarea><br />
...
function sendEmail(obj){
	...
	var zdy=document.getElementById("zidingyi").value;
    		var mailTitle="公司部门负责人行程安排表(<%=startdate %>-<%=enddate %>)";
		    jQuery.ajax({
		        //提交数据的类型 POST GET    
		        type : 'POST',    
		        //提交的网址    
