...
if(sublist.size()>0){
	...
	%>
		...
		<TD noWrap><input type="hidden" id="<%="field_40285a904931f62b014950dd0217317a_"+no%>"  name="<%="field_40285a904931f62b014950dd0217317a_"+no%>"   value="<%=pzledgerobj%>"  ><span style='width: 80%' id="<%="field_40285a904931f62b014950dd0217317a_"+no+"span"%>"  name="<%="field_40285a904931f62b014950dd0217317a_"+no+"span"%>"  ><%=pzledgerobj%></span></TD>
