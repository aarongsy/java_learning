...
<link rel="stylesheet" href="/culture/css/share.css"/>
...
.timecss .tab{text-align: center;border:1px solid blank;}
  ...
  if(fck>-1){
    ...
    function addMonth() {
    	...
    	window.location.href = "/workflow/request/meetingRoomSchedule.jsp?disDate=" + disDate + "&len=1";
    }
    ...
    function meetRoomInfo(day) {
    	...
    	window.location.href = "/workflow/request/meetingRoomSchedule.jsp?date=" + date + "&disDate=" + disDate + "&len=0";
        }
...
<body>
    <div class="meetingcontent">
		...
		<div id="dateid">
		    	<IMG src="/htfapp/images/logo_signRequest.gif">
		    	<div class="layoutdiv">
		    		<h1 style="font-size: 20px;">会议室预定</h1>
		    	</div>
		</div>
		<div style="width:1000px;text-align: center;margin-top: 0px;">
		...
		<table border="0px;" cellpadding="0" cellspacing="0">
			...
			<tbody>
				<tr>
					...
					<td align="center"><input type="text" id="field_4028818230686b490130691901460043" name="field_4028818230686b490130691901460043" value="<%=DateHelper.getCurrentDate()%>"  style='width: 100%' class=inputstyle size=10   onclick="WdatePicker()"/></td>
