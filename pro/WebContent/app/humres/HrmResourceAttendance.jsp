...
<!-- 			<td>
			<table border=1 cellspacing=0 cellpadding=0 bgcolor="">
			<tr style="display:none"><td bgcolor="<%=color4%>" width="15" style="border-width:1;height:15"></td></tr>
			</table>
			</td><td>
			&nbsp;考勤
			</td> -->
  ...
  <table class=MI id=AbsenceCard style="BORDER-RIGHT: 1px solid; TABLE-LAYOUT: fixed; FONT-SIZE: 8pt; WIDTH: 100%; CURSOR: and; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0>
	...
	sql="select top 1 date1,convert(varchar(10),date1) date,convert(varchar,cast(date1 as datetime),108) time,hrmid,ip from attendance where attendance=1";
			...
			else  
			{
				...
				if(!bgcolor.equals(color2)){
					...
					for(int k=0 ; k<size3 ; k++) {
						...
						{
							adjustDays=Integer.parseInt(StringHelper.null2String(m.get("reqDays")) );
							continue;
						}
