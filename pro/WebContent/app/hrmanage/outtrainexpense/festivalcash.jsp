...
<%
	...
	String sql = " select t.month from uf_hr_festivalcash t where  t.requestid='"+requestid+"'";
	//薪资发放月
	List tlist = baseJdbc.executeSqlForList(sql);
	if(tlist.size()>0){
		Map map = (Map)tlist.get(0);
		String month = StringHelper.null2String(map.get("month"));//薪资发放月
		...
		sql = "select t.money,t.sapid from uf_hr_festivalcashsub t where t.requestid='"+requestid+"'";
		//人员编号，金额，货币代码
		...
		String upsql="update uf_hr_festivalsapinfo set msgty='"+MSGTY+"',msgtx='"+MESSAGE+"' where requestid='"+requestid+"' and sapid='"+sapno+"'";
