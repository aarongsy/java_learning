...
//事假时数 
String sql = "select sum(NVL(a.hours,0)) hours from uf_hr_vacation a,requestbase b where a.requestid=b.id and b.isdelete=0 and a.isvalided='40288098276fc2120127704884290210' and a.objname='"+hid+"' and (a.reqtype='40285a904931f62b0149368f73df1e5a' or a.reqtype='40285a904931f62b0149368f74a51e92')";
...
<TD  noWrap class="td2"  align=center>旷工次数</TD>
