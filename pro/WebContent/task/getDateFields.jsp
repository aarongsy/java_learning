...
<%
	...
	%>
	 <select id="datefield" name="datefield" onchange="myChange()">						  						   
	<%
	for (int k = 0; k < forminfolists.size(); k++) {
		Forminfo forminfo = (Forminfo) forminfolists.get(k);
		String tempformid = forminfo.getId();
		List formfieldlist = formfieldService.findFormfield("from Formfield where formid = '"+tempformid+"' and htmltype = '1' and fieldtype = '4' and (isdelete is null or isdelete = 0)");
