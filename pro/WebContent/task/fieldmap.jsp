...
function setCondition2(){
	...
	for(var i=0; i<allfield.length; i++){
		...
		var fieldid = document.all(input + "_fieldid").value;
	...
	if(conditions2.indexOf("and")== -1){
		...
		document.all("conditiontext").value = conditionstext2.substr(0,conditionstext2.lastIndexOf("<%=labelService.getLabelNameByKeyId("402883cd353c1e6b01353c1e6be60067") %>")-1) + "";
