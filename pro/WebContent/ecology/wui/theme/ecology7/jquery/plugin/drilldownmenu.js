...
function drilldownmenu(setting){
	this.sublevelarrow={src:'/wui/theme/ecology7/page/images/leftmenu/item_right.gif', width:'8px', top:'3px', left:'6px'}; //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow='/wui/theme/ecology7/page/images/leftmenu/url_right.gif'; //full URL to image separating breadcrumb links (if it's defined)
	this.loadingimage='/wui/theme/ecology7/page/images/leftmenu/loader.gif'; //full URL to 'loading' image, if menu is loaded via Ajax
	this.homecrumbtext = (setting.homeDir == undefined || setting.homeDir == null || setting.homeDir == "") ? '́Ȥ' : setting.homeDir; //Top level crumb text
	this.titlelength=35; //length of parent LI text to extract from to use as crumb titles
	this.backarrow='/wui/theme/ecology7/page/images/leftmenu/leftarrow.gif'; //full URL to image added in front of back LI 
