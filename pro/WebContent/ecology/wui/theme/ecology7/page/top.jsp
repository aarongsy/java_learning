...
<style>
    ...
    .slideItemText{padding-left:14px;padding-right:3px;text-align:right;font-family:"微软雅黑","verdana";font-size:11px;color:#EFEFEF;margin-top:2px;font-weight:bold;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;}
