...
if (topleftbarBgImage_left.equals("")) {
	topleftbarBgImage_left = "/wui/theme/ecologyBasic/page/images/left/topFolde_leftr.png";
}
if (topleftbarBgImage_center.equals("")) {
	topleftbarBgImage_center = "/wui/theme/ecologyBasic/page/images/left/topFolde_center.png";
}
if (topleftbarBgImage_right.equals("")) {
	topleftbarBgImage_right = "/wui/theme/ecologyBasic/page/images/left/topFolde_right.png";
}

//左菜单分类背景图(1*26)
if (leftbarBgImage.equals("")){
	leftbarBgImage = "/wui/theme/ecologyBasic/page/images/left/leftbarBgImage.png";
}

if (leftbarBgImageH.equals("")){
	leftbarBgImageH = "/wui/theme/ecologyBasic/page/images/left/leftbarBgImageH.png";
}
...
if (bottomleftbarBgImage_left.equals("")){
	bottomleftbarBgImage_left = "/wui/theme/ecologyBasic/page/images/left/thumbBoxBg_left.png";
}
if (bottomleftbarBgImage_center.equals("")){
	bottomleftbarBgImage_center = "/wui/theme/ecologyBasic/page/images/left/thumbBoxBg_center.png";
}
if (bottomleftbarBgImage_right.equals("")){
	bottomleftbarBgImage_right = "/wui/theme/ecologyBasic/page/images/left/thumbBoxBg_right.png";
}
%>
...
<script language="javascript" src="/wui/common/jquery/plugin/jquery.easydrag.js"></script>
...
function getXML(){
	...
	//xmlDoc = $.parseXML( '<%=xmlMenuStr.append("</menu>").toString()%>' ),
	//alert('<%=xmlMenuStr.append("</menu>").toString()%>' )
    $xml = $( '<%=xmlMenuStr.append("</menu>").toString()%>' )
    //alert($xml.find('menubar[id=1]').length)
...
function createMenu(){
	...
	oTD.innerHTML = "<img src=\"/images/StyleGray/handleH.gif\" style=\"margin-top:1px\"/>";
	...
	oTD.id = "thumbBox";
	oTD.style.position = "relative";
	oTD.innerHTML = "<table cellspacing=\"0\" cellpadding=\"0\" height=\"28px\" width=\"100%\" style=\"top:0;left:0;z-index:-1;\"><tr height=\"100%\" width=\"100%\"><td height=\"100%\" width=\"65px\" class=\"bottomThumbBox_bg_left\">&nbsp;</td><td height=\"100%\" width=\"*\" align='right' class=\"bottomThumbBox_bg_center\">&nbsp;<img id='rightArrow' style='cursor:pointer;' src='/images/StyleGray/rArrow.gif' onclick='showFav(this)'/></td><td height=\"100%\" width=\"5px\" class=\"bottomThumbBox_bg_right\"></td></tr></table>";
...
function slideFolder(o){
	...
	if(nodeMenubar.attr("extra")==null){
		loadHTML();
	}else if(nodeMenubar.attr("extra")=="systemSetting"){
		loadJSP();
	}else if(nodeMenubar.attr("extra")=="myReport"){
		loadJSP();
	}else if(nodeMenubar.attr("extra")=="infoCenter"){
...
if(UsrTemplate.getMenuborderbg().equals("")||UsrTemplate.getMenuborderbg().equals("0")){
	leftmenuBoxBg="/images/StyleGray/leftmenuBoxBg.jpg";
	leftmenuToggleBg="/images/StyleGray/leftmenuToggleBg.jpg";
%>
	...
	<td id="tdDrag" style="height:100%;width:8px;padding:0px 0 0px 0px;background:<%=menuborderColor%>;text-align:center;"><img src="/images/StyleGray/handleV.gif"/></td>
...
<%}else if(!UsrTemplate.getMenuborderbg().equals("0")){
	...
	<td id="tdDrag" style="height:100%;width:8px;padding:0px 0 0px 0px;background-image:url(<%=leftmenuToggleBg%>);text-align:center"><img src="/images/StyleGray/handleV.gif"/></td>
<%}
