...
//try {ieVersion = parseFloat(navigator.appVersion.split("MSIE")[1]);}catch(e){}
...
<!--WUI -->
<%@ include file="/ecology/wui/common/page/initWui.jsp" %>
...
//------------------------------
//var GLOBAL_SKINS_FOLDER = "<%=(curskin != null && !curskin.equals("")) ? curskin : "default"%>";
//当前使用的主题
...
<!--
<script language="javascript" type="text/javascript" src="/wui/blue/jquery/jquery.js"></script>
<script language="javascript" type="text/javascript" src="/wui/blue/jquery/plugin/wuiform/wuiform.js"></script>
<link type='text/css' rel='stylesheet'  href='/wui/blue/jquery/plugin/jqtransform/wuiform.css'/>  
-->