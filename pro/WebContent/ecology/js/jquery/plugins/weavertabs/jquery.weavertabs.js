			...
			$(this).children("table").children("tbody").children("tr").children("td").each(function(i,n){
				$(this).bind("click",function(){			
					if($(this).css("background")!="#FFFFFF"){
						$(this).parent().children().css("background","url('/js/jquery/plugins/weavertabs/tab.gif') repeat-x");
				...
				if(i==param.selected) {
					...
					//$(this).css("background","#FFFFFF");
					$(this).css("background","url('/js/jquery/plugins/weavertabs/tab.gif') repeat-x");
