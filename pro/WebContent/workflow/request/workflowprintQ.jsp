...
{  
  ...
  var url="/workflow/request/workflowprintview.jsp";
...
<iframe id="printContent" name="printContent" src="workflowprint.jsp?pstyle=<%=pstyle%>&printLayout=<%=printLayout%>&workflowid=<%=workflowid%>&requestid=<%=requestid%>&nodeid=<%=nodeid%>&printType=<%=printType%>&show=<%=show%>&checkbox1=<%=checkbox1%>&checkbox2=<%=checkbox2%>" style="display:none">
</iframe>
</body>
</html> 
