...
<%
	...
	Formlayout formlayout = formlayoutService.getMobileLayoutInfo(layoutid,
   ...
   <div id='properties'>
	...
	<TR><TD class="Line"></TD></tr>
     ...
     <tr class="TableHeader"><td align="center"><b><%=labelService
      ...
      <input type="hidden" name="supportedclient" value="1">
...
<script >
  	function reloadmainwin(){
   	...
   	function getBrowser(){
		...
		var url="/workflow/workflow/showcondition.jsp?condition="+condition;
