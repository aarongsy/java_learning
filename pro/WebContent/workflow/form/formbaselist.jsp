...
<html>
 ...
 Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021") %>';/加载中,请稍后...
  ...
  <%
   String action=request.getContextPath()+"/ServiceAction/com.eweaver.workflow.form.servlet.FormbaseAction?action="+towhere+"&userid="+uid+"&opttype="+opttype;
  %>
    ...
    store = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            fields: ['creator','createdate','modifier','modifydate','category','formbase','id']
        })
...
//    var sm=new Ext.grid.CheckboxSelectionModel();
    var cm = new Ext.grid.ColumnModel([ {header: "<%=labelService.getLabelNameByKeyId("402881eb0bd74dcf010bd752d0860006") %>",  sortable: false,  dataIndex: 'creator'},//创建者
                {header: "<%=labelService.getLabelNameByKeyId("402881eb0bd712c6010bd72253df000c") %>",  sortable: false,  dataIndex: 'createdate'},//创建日期
                {header: "<%=labelService.getLabelNameByKeyId("402881eb0bd74dcf010bd753543d0007") %>",  sortable: false,  dataIndex: 'modifier'},//修改者
                {header: "<%=labelService.getLabelNameByKeyId("402881eb0bd712c6010bd721dd76000b") %>",  sortable: false,  dataIndex: 'modifydate'},//修改日期
                {header: "<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39340039") %>", sortable: false,   dataIndex: 'category'},//所属分类
            {header: "", sortable: false,   dataIndex: 'formbase'}]);
