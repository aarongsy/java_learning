...
String sql = SQLMap.getSQLString("workflow/chart/usage_org_chart.jsp");
...
<html>
	<head>
		<title><%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39330030") %><!-- 部门使用流程统计 --></title>
		<style type="text/css">
		td{padding:1px;}
		</style>
	</head>
	...
	<body>
		<div style="float: left;padding:10px;">
			<table width="50%" border="1" cellpadding="0" cellspacing="0">
				<caption >
					<span style="font-weight: bold;padding:5px;"><%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39330030") %><!-- 部门使用流程统计 --></span>
