...
if(operatemode.equals("submit")||operatemode.equals("save")){
	...
	baseJdbc.update("update  uf_customer set suppstatus=decode((select totaladvise from uf_ser_article  where requestid='"+requestid+"'),'2c91a0302bbcd476012be61178770a3c','2c91a0302bbcd476012be214af8b06a2','2c91a0302bbcd476012be61178770a3d','2c91a0302bbcd476012be214af8b06a3','2c91a0302bbcd476012be214af8b06a2'),firstevadate='"+DateHelper.getCurrentDate()+"',evatimes=1,files=(select files from uf_ser_article  where requestid='"+requestid+"') where requestid=(select rmdsname1 from  uf_ser_article  where requestid='"+requestid+"')");
