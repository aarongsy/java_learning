...
if(operatemode.equals("submit")||operatemode.equals("save")){
	String sql = "update uf_device_equipment set equipmentstate = '2c91a0302c2fe2d1012c349aa31e0390' where requestid in (select devicesn from uf_device_borrow_sub where requestid = '"+requestid+"')";
