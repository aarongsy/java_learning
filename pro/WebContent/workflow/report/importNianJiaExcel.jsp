...
<br><br><br>
        ...
        <table style="border:0">
            ...
            <TR height="30"><TD class=Spacing colspan=3 align="center">请在下面选择需要导入的excel文档</TD><TR>
	
            <TR height="30"><TD colspan=3 align="center"><input type="file" name="path" style="width:400"/></TD><TR>
					<tr><td colspan=3 align="center" ><button onclick="importRecords()" class="btn" >导入</button>&nbsp;&nbsp;&nbsp;<button onclick="document.forms[0].reset();" class="btn">取消</button></td></tr>
...
<script language="javascript">
    ...
    function importRecords(){
		...
		document.forms[0].action="<%=request.getContextPath()%>/ServiceAction/com.eweaver.excel.util.ImporNianJiaDataAction?action=xmlupload&requestid=<%=requestid%>";
