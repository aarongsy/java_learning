...
<html>
 ...
 Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021")%>';//加载中,请稍后...
  ...
  <%
   String action=request.getContextPath()+"/ServiceAction/com.eweaver.workflow.report.servlet.ReportdefAction?action="+towhere+"&userid="+uid+"&opttype="+opttype;
  %>
    ...
    store = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            fields: ['objname','objtype','formid','moduleid','id']
        })
...
//    var sm=new Ext.grid.CheckboxSelectionModel();
    var cm = new Ext.grid.ColumnModel([ {header: "<%=labelService.getLabelNameByKeyId("402881e80ca5d67a010ca5e245050009")%>",  sortable: false,  dataIndex: 'objname'},//报表名称
                {header: "<%=labelService.getLabelNameByKeyId("402881540c9f83d6010c9f9c69800006")%>",  sortable: false,  dataIndex: 'objtype'},//报表类型
                {header: "<%=labelService.getLabelNameByKeyId("402883d934d152ce0134d152cf2b0069")%>",  sortable: false,  dataIndex: 'formid'},//所属表单
...
function onSubmit(){
     var o=$j('#EweaverForm').serializeArray();
       ...
       store.load({params:{start:0, limit:2000}});
}
