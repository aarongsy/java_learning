...
var Runner = function(){
  ...
  <script type="text/javascript">
    ...
    function myshow(data){
      ...
      function importExcel(){
          document.forms[0].action="<%=request.getContextPath()%>/ServiceAction/com.eweaver.excel.servlet.ExcelUpLoadAction?action=excelUpLoad&workflowid=<%=workflowid%>";
          document.forms[0].submit();
      }
  ...
  <tr>
    ...
    <td width="104" align="center"><input name="button" type="button" class="mysubmit2" id="Submit1" onclick="myshow('1')" value="<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39330032") %>"/><!-- 导出操作 -->
    </td>
  ...
  <tr>
    <td colspan="3" >
      <table width="750" border="0" bordercolor="#CCCCCC" id="Layer1" style="font-size:14">
        ...
        <tr>
            <td>&nbsp;&nbsp;<%=labelService.getLabelNameByKeyId("402883d934d152ce0134d152cf2a005a") %><!-- 1.需要导出的列,可以在被导出流程表单的EXCEL导入导出列的设置中设置; --></td>
        </tr>
        <tr>
            <td>
            &nbsp;
        ...
        <tr>
            <td>&nbsp;&nbsp;<%=labelService.getLabelNameByKeyId("402883d934d152ce0134d152cf2a005b") %><!-- 2.请注意,被导出的数据仅仅属于您所选择的流程,而相同表单下的其它流程或分类数据将不会被导出; --></td>
        </tr>
        ...
        <tr>
            <td align="center">
            <a id="outPutExcelBtn" href="javascript:void(0)" style="font-size:14"><%=labelService.getLabelNameByKeyId("402883d934d152ce0134d152cf2a005c") %><!-- 导出流程数据 --></a>&nbsp;&nbsp;&nbsp;<a id="showResult" href="javascript:showMyResult()"></a>
...
<script type="text/javascript">
    //*********************************模式对话框特效(start)*********************************//
          ...
          title.innerHTML="<%=labelService.getLabelNameByKeyId("labelService.getLabelNameByKeyId("297eb4b8126b334801126b906528001d")") %>";//关闭
