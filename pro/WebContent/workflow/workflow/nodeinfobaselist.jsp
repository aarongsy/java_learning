...
<html>
 ...
 Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021") %>';//加载中,请稍后...
  ...
  <%
   String action=request.getContextPath()+"/ServiceAction/com.eweaver.workflow.workflow.servlet.NodeinfoAction?action="+towhere+"&userid="+uid+"&opttype="+opttype;
  %>
    ...
    store = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            ...
            fields: ['objname','workflowid','formid','moduleid','id']
        })
...
//    var sm=new Ext.grid.CheckboxSelectionModel();
    var cm = new Ext.grid.ColumnModel([ {header: "<%=labelService.getLabelNameByKeyId("402881ee0c715de3010c7248aaad0072") %>",  sortable: false,  dataIndex: 'objname'},//节点名称
                {header: "<%=labelService.getLabelNameByKeyId("402881ee0c715de3010c7249ba5b0078") %>",  sortable: false,  dataIndex: 'workflowid'},//所属流程
