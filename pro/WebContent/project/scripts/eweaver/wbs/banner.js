...
//	                    		EdoGantt.showTaskWindow('addSubProject',task);
	                    		project.tree.clearSelect();
	                    		EdoGantt.showTaskWindow('addSubProject');
	                        }
	                    },{
	                        type: 'button',
	                        icon: 'e-icon-new',
...
//	                    		EdoGantt.showTaskWindow('new',task);
	                        ...
	                        onclick: function(e){
	                    		var task = project.tree.getSelected();
	                    		var isAddTempNode = false;
	                    		EdoGantt.showTaskWindow('templet',task);
	                        }
	                    },
//	                    {
//	                        type: 'button',
...
//                        	    		var parentNode = project.tree.data.findParent(o);
...
//	                    },
	                    {
	                        ...
	                        type: 'split',visible: isCanjizhushezhi
	                    },{
	                        type: 'button',text: '机组进度设置',visible: isCanjizhushezhi,
	                        onclick: function(e){
	                    		onUrl('/app/ft/pcSetPorgress.jsp?projectid='+ProjectUID,'机组进度设置');
	                        }
	                    }
	                ]
	            }
