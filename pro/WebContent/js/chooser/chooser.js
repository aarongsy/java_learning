...
ImageChooser.prototype = {   
    ...
    show : function(el, callback){   
        if(!this.win){   
            ...
            this.view = new Ext.DataView({   
                ...
                emptyText : '<div style="padding:10px;">没有章印，请与管理员联系！！</div>',
                store: this.store,   
                listeners: {   
            ...
            var cfg = {   
                ...
                listeners:{'beforeclose':this.closeWin},
                buttons: [{   
                    id: 'ok-btn',   
                    text: 'OK',   
    ...
    closeWin:function(win){
    	if(Ext.getDom('DocWebOffice'))Ext.getDom('DocWebOffice').style.display='block';
