...
(function($)
{
	var menus = [], //list of all menus
		...
		activeMenu = activeItem = null,//<div class="shadowbox1"></div><div class="shadowbox2"></div><div class="shadowbox3"></div>
	...
	$.extend($.MenuItem, {
		prototype : {
			init : function()
			{
				...
				if(!this.separator){//not bind event.
