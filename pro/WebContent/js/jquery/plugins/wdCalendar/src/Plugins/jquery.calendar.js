...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        var def = {
            ...
            readonly: false,
            /**
             * @description {Config} canCreate  
             * {Boolean} 设置此项为false之后，可以编辑但是不可以通过鼠标选择区域之后快速创建日程。
             */
            canCreate: true,
            /**
        ...
        function getTitle(event) {			
            ...
            attendsshow = (event[10] != undefined && event[10] != "") ? "" : "";
            var ret = [];
            if (event[4] == 1) {
        ...
        function initevents(viewtype) {
            if (viewtype == "week" || viewtype == "day") {
                ...
                if (option.readonly == false && option.canCreate == true) {
