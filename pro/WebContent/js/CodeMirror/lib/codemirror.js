...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
        ...
        '<div style="position: relative">' + // Set to the height of the text, causes scrolling
          '<div style="position: relative">' + // Moved around its parent to cover visible view
            ...
            '<div class="CodeMirror-lines"><div style="position: relative; z-index: 0">' +
              ...
              '<div class="CodeMirror-measure" style="position: absolute; width: 100%; height: 0; overflow: hidden; visibility: hidden;"></div>' +
              '<pre class="CodeMirror-cursor">&#160;</pre>' + // Absolutely positioned blinky cursor
              '<pre class="CodeMirror-cursor" style="visibility: hidden">&#160;</pre>' + // Used to force a width
              '<div style="position: relative; z-index: -1"></div><div class="CodeMirror-lineDiv"></div>' + // DIVs containing the selection and the actual code
            '</div></div></div></div></div>';
    ...
    function readInput() {
      ...
      if(!(text.slice(same).length > 1 && getSelection().length == text.slice(same).length))
    ...
    function updateDisplay(changes, suppressCallback, scrollTop) {
      ...
      function checkHeights() {
        ...
        doc.iter(showingFrom, showingTo, function(line) {
          if (!line.hidden) {
            var height = Math.round(curNode.scrollHeight / th) || 1;
    ...
    function updateGutter() {
      ...
      var hText = mover.scrollHeight, hEditor = scroller.clientHeight;
      ...
      var resized = Math.abs((parseInt(lineSpace.style.marginLeft) || 0) - gutter.scrollWidth) > 2;
      lineSpace.style.marginLeft = gutter.scrollWidth + "px";
      gutterDirty = false;
      return resized;
    }
    ...
    function textHeight() {
      ...
      cachedHeight = measure.firstChild.offsetHeight / 50 || 12;
      measure.innerHTML = "";
      return cachedHeight;
    }
