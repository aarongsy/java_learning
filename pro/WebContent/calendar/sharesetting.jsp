...
<%
 ...
 %>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/js/ext/ux/miframe.js"></script>
		<title><%=labelService.getLabelNameByKeyId("402883c134f8ef330134f8ef33f80013")%><!-- 共享日程设置 --></title>
   ...
   <%}%>	
       ...
       var cm = new Ext.grid.ColumnModel([sm, {header: "<%=labelService.getLabelNameByKeyId("402883c134f8ef330134f8ef33f8002b")%>", sortable: false,  dataIndex: 'objname'},//共享类型
           {header: "<%=labelService.getLabelNameByKeyId("402883c134f8ef330134f8ef33f8001b")%>", sortable: false,   dataIndex: 'shareLevelName'},//共享级别
           {header: "<%=labelService.getLabelNameByKeyId("402883c134f8ef330134f8ef33f8002c")%>",  sortable: false, dataIndex: 'shareObj'},//共享对象类型
           {header: "<%=labelService.getLabelNameByKeyId("402883c134f8ef330134f8ef33f80019")%>",  sortable: false, dataIndex: 'shareObjnames'},//共享对象
           {header: "<%=labelService.getLabelNameByKeyId("402881e70b774c35010b774cceb80008")%>",  sortable: false, dataIndex: 'securitylevel'},//安全级别
