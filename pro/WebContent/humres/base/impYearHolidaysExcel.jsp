...
<%
	...
	String sql = "select a.orgid,b.reftype,a.atyear,b.objname from uf_attendance_yearhld a,orgunit b where a.requestid='"+requestid+"' and b.id=a.orgid ";
	DataService ds = new DataService();
	Map map  = ds.getValuesForMap(sql);
	String atyear = StringHelper.null2String(map.get("atyear"));
	String orgname = StringHelper.null2String(map.get("objname"));
%>
<html>
...
<form action="<%=request.getContextPath()%>/ServiceAction/com.eweaver.excel.servlet.ImpYearHolidaysAction?action=create" name="EweaverForm" id="EweaverForm" method="post" enctype="multipart/form-data">
<center>
<br><br><br>
        ...
        <table style="border:0">
            ...
            <TR height="30"><TD class=Spacing colspan=3 align="center">当前为：<%=atyear%>年度，组织单元：/<%=orgname %><br />请在下面选择需要导入的excel文档</TD><TR>
	
            <TR height="30"><TD colspan=3 align="center"><input type="file" name="path" style="width:400"/></TD><TR>
					<tr><td colspan=3 align="center" ><button type="button" onclick="importRecords()" class="btn" >导入</button>&nbsp;&nbsp;&nbsp;<button type="button" onclick="document.forms[0].reset();" class="btn">取消</button></td></tr>
...
<script language="javascript">
    ...
    function importRecords(){
		...
		document.forms[0].action="<%=request.getContextPath()%>/ServiceAction/com.eweaver.excel.servlet.ImpYearHolidaysAction?action=xmlupload&requestid=<%=requestid%>";
