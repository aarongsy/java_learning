    ...
    $.fn.autoSearchComplete = function(option){
        ...
        $(this).each(function(){
            ...
            $(this).append(				
	            ...
	            '<div class="divLoading"><img src="tree/themes/default/throbber.gif"> Loading...</div>'+
	            '</div>'
			);
           ...
           var isLoadding=false;
		    $(this).find("input").bind("keydown",function(e,isFromSearchButton){
                ...
                if (code == 13||isFromSearchButton==true) {//enter
                    ...
                    isLoadding=true;					
                    //loadding
                    //$this.find(".autoSearchComplete_search_cancel img").attr("src","autosearchcomplete/icon-loadding.gif");  
