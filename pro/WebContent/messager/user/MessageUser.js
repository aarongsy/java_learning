...
MessageUser.prototype.toString=function(){
	...
	var imgStr="/messager/images/icon-offline.gif";	
	alerlt("uuuuuuuuuuuuuuuuuuuuuu");
	if(ControlUser.isUserOnline(this.para.loginid)) imgStr="/messager/images/icon-available.gif";
	var imgIcon="/messager/images/icon-blue.gif";
