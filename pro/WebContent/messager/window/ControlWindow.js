var ControlWindow={
	...
	getWindowPos:function(width,height){		
		...
		var tmpLeft=parseInt(screen.width)/2-parseInt(width)+30*ControlWindow.intMessagerWindowNum+280;
		var tmpTop=parseInt(screen.height)/2-parseInt(height)+40*ControlWindow.intMessagerWindowNum+80;	
		return {
			left:tmpLeft,
			top:tmpTop
		}
