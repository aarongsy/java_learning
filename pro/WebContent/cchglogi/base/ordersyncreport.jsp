...
<%
String action=request.getContextPath()+"/ServiceAction/com.eweaver.app.sap.product.OrderSyncAction?action=search";
%>
<%
         ...
         <script language="javascript">
          Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021")%>';//加载中,请稍后...
			...
			var cm = new Ext.grid.ColumnModel([sm,
                                               ...
                                               {header:'销售订单项次' ,dataIndex: 'salesitem',hidden: false ,width:30,sortable: true},
                                               {header:'订单类型' ,dataIndex: 'salestype',hidden: false ,width:30,sortable: true},
                                               {header:'销售客户订单号' ,dataIndex: 'customerno',hidden: false ,width:30,sortable: true},
                                               {header:'售达方客户代码' ,dataIndex: 'soldto',hidden: true ,width:30,sortable: true},
                                               {header:'售达方客户名称' ,dataIndex: 'soldtoname',hidden: false ,width:30,sortable: true},
                                               {header:'送达方代码' ,dataIndex: 'shipto',hidden: false ,width:30,sortable: true},
                                               {header:'送达方名称' ,dataIndex: 'shiptoname',hidden: false ,width:30,sortable: true},
                                               {header:'送达方地点和描述' ,dataIndex: 'shiptoaddress',hidden: true ,width:30,sortable: true},
                                               {header:'物料号码' ,dataIndex: 'materialno',hidden: true ,width:30,sortable: true},
                                               {header:'物料描述' ,dataIndex: 'materialdesc',hidden: false ,width:30,sortable: true},
                                               {header:'销售订单数量' ,dataIndex: 'quantity',hidden: false ,width:30,sortable: true},
                                               {header:'单位代码' ,dataIndex: 'salesunit',hidden: true ,width:30,sortable: true},
                                               {header:'单位说明' ,dataIndex: 'unitoftext',hidden: false ,width:30,sortable: true},
                                               {header:'工厂' ,dataIndex: 'plant',hidden: false ,width:30,sortable: true},
                                               {header:'固定/散装包装' ,dataIndex: 'materialtype',hidden: true ,width:30,sortable: true},
                                               {header:'计划交货日期' ,dataIndex: 'planneddate',hidden: false ,width:30,sortable: true},
                                               {header:'包装代码' ,dataIndex: 'packagecode',hidden: true ,width:30,sortable: true},
                                               {header:'生产/检验备忘录' ,dataIndex: 'dangerous',hidden: true ,width:30,sortable: true},
  ...
  <table>
   ...
   <tr>
    ...
    <td  class="FieldValue"  nowrap>
           <input type=text class=inputstyle style="width:80%" name="vbeln_vl" id="vbeln_vl" value="0000217593" >
    </td>
...
<script language="javascript">
   ...
   function syncDo(){
	   try{
	       ...
	       Ext.Ajax.request({
	    	    url: '<%=request.getContextPath()%>/ServiceAction/com.eweaver.app.sap.product.OrderSyncAction',
	    	    params: {
	    	     jsonstr : selected+"",
	    	     action : "synchronous"
	    	     //配置传到后台的参数
