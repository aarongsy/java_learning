...
<%
String action=request.getContextPath()+"/ServiceAction/com.eweaver.app.trade.servlet.PurchaseOrderSyncAction?action=search";
%>
<%
    ...
    <script language="javascript">
          Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021")%>';//加载中,请稍后...
			...
			var cm = new Ext.grid.ColumnModel([sm,
			                                   {header:'采购订单号',dataIndex:'ebele',hidden: false ,width:30,sortable: true},
			                                   {header:'订单类型',dataIndex:'bsart',hidden: true ,width:30,sortable: true},
			                                   {header:'订单类型描述',dataIndex:'batxt',hidden: false ,width:30,sortable: true},
			                                   {header:'供应商编码',dataIndex:'lifnr',hidden: true ,width:30,sortable: true},
			                                   {header:'供应商名称',dataIndex:'name1',hidden: false ,width:30,sortable: true},
			                                   {header:'付款条款代码',dataIndex:'zterm',hidden: true ,width:30,sortable: true},
			                                   {header:'付款条款文本',dataIndex:'text1',hidden: false ,width:30,sortable: true},
			                                   ...
			                                   {header:'币种	',dataIndex:'waers',hidden: false ,width:30,sortable: true},
			                                   {header:'汇率	',dataIndex:'wkurs',hidden: false ,width:30,sortable: true},
			                                   {header:'采购订单日期',dataIndex:'bedat',hidden: false ,width:30,sortable: true},
			                                   {header:'订单总金额',dataIndex:'rlwrt',hidden: true ,width:30,sortable: true},
			                                   {header:'含税总金额',dataIndex:'taxes',hidden: true ,width:30,sortable: true},
			                                   {header:'申请凭证编号',dataIndex:'bbsrt',hidden: false ,width:30,sortable: true},
			                   				   {header:'公司代码	',dataIndex:'bukrs',hidden: true ,width:30,sortable: true},
			                                   {header:'公司别',dataIndex:'butxt',hidden: false ,width:30,sortable: true}
			         							]);       
...
<div id="divSearch">
 ...
 <form id="EweaverForm" name="EweaverForm" action="<%=action%>">
  <table>
   ...
   <tr>
 	<td  class="FieldName" nowrap>采购订单号</td>
    <td  class="FieldValue"  nowrap>
           <input type=text class=inputstyle style="width:80%" name="ebeln" id="ebeln" value="4500045632" >
    </td>
...
<script language="javascript">
   ...
   function syncDo(){
	   try{
	       ...
	       Ext.Ajax.request({
	    	    url: '<%=request.getContextPath()%>/ServiceAction/com.eweaver.app.trade.servlet.PurchaseOrderSyncAction',
	    	    params: {
	    	     jsonstr : selected+"",
	    	     action : "synchronous"
	    	     //配置传到后台的参数
