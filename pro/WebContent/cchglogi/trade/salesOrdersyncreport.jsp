...
<%
String action=request.getContextPath()+"/ServiceAction/com.eweaver.app.trade.servlet.SalesOrderSyncAction?action=search";
%>
<%
         ...
         <script language="javascript">
          Ext.LoadMask.prototype.msg='<%=labelService.getLabelNameByKeyId("402883d934cbbb380134cbbb39320021")%>';//加载中,请稍后...
			...
			var cm = new Ext.grid.ColumnModel([sm,
			                                   {header:'销售订单编号',dataIndex:'vbeln',hidden: false ,width:30,sortable: true},
			                                   {header:'销售订单类型',dataIndex:'auart',hidden: true ,width:30,sortable: true},
			                                   {header:'销售订单类型描述',dataIndex:'typed',hidden: false ,width:30,sortable: true},
			                                   {header:'采购订单编号',dataIndex:'bstnk',hidden: false ,width:30,sortable: true},
			                                   {header:'利润中心',dataIndex:'prctr',hidden: false ,width:30,sortable: true},
			                                   {header:'公司代码',dataIndex:' bukrs_vf',hidden: true ,width:30,sortable: true},
			                                   {header:'公司别名',dataIndex:'butxt',hidden: false ,width:30,sortable: true},
			                                   {header:'特殊处理标记',dataIndex:'sdabw',hidden: true ,width:30,sortable: true},
			                                   {header:'特殊处理标记描述',dataIndex:'specd',hidden: false ,width:30,sortable: true},
			                                   {header:'售达方',dataIndex:'kunnr',hidden: true ,width:30,sortable: true},
			                                   {header:'售达方名称',dataIndex:'name1',hidden: false ,width:30,sortable: true},
			                                   {header:'售达方国别',dataIndex:'land1',hidden: true ,width:30,sortable: true},
			                                   {header:'售达方地址',dataIndex:'stras1',hidden: true ,width:30,sortable: true},
			                                   {header:'送达方',dataIndex:'sunnr',hidden: true ,width:30,sortable: true},
			                                   {header:' 送达方名称',dataIndex:'name2',hidden: false ,width:30,sortable: true},
			                                   {header:'送达方国别',dataIndex:'land2',hidden: true ,width:30,sortable: true},
			                                   {header:'送达方地址',dataIndex:'stras2',hidden: true ,width:30,sortable: true},
			                                   {header:'付款条款代码',dataIndex:'zterm',hidden: true ,width:30,sortable: true},
			                                   {header:'付款条款描述',dataIndex:'text1',hidden: false ,width:30,sortable: true},
			                                   {header:'国贸条件1',dataIndex:'inco1',hidden: true ,width:30,sortable: true},
			                                   {header:'国贸条件描述',dataIndex:'bezei',hidden: false ,width:30,sortable: true},
			                                   {header:'国贸条件2',dataIndex:'inco2',hidden: true ,width:30,sortable: true},
			                                   {header:'币种	',dataIndex:'waerk',hidden: true ,width:30,sortable: true},
			                                   {header:'付款方式代码',dataIndex:'zlsch',hidden: true ,width:30,sortable: true},
			                                   {header:'付款方式描述',dataIndex:'text2',hidden: false ,width:30,sortable: true}
			         							]);       
