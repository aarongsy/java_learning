...
function initWBS(name){
	var childTasksDiv = document.getElementById("childTasksDiv");
	childTasksDiv.style.display = "block";
	treetable = new TreeTable(name);
	project = new Project(data);
	treetable.loadTask(project.tasks);
}
...
function onAdd(projectid,pid){
	...
	openchild(url,'新建任务','bullet_plus',800,h);
}
