...
<%
   ...
   if(selectItemId.equals("")) selectItemId = "402881e80b9a072f010b9a38f931000d";//默认资源
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/js/ext/resources/css/RowActions.css" type="text/css">
  ...
  <script type="text/javascript" src="<%=request.getContextPath()%>/js/ext/ux/iconMgr.js"></script>
      ...
      <%
      String action=request.getContextPath()+"/ServiceAction/com.eweaver.base.security.servlet.SysresourceAction?action=browserm";
  ...
  List listidsin=StringHelper.string2ArrayList(idsin,",");
    ...
    for(int i=0;i<listidsin.size();i++)
    {
     ...
     // String showname="<a href=\"javascript:onUrl("+refobj1.getViewurl()+id+","+showfieldname+",tab"+id+")\" >"+showfieldname+"</a>";
      ...
      var cm = new Ext.grid.ColumnModel([sm,{header: "资源名称", sortable: false,  dataIndex: 'resname'},
           {header: "资源描述", sortable: false,   dataIndex: 'resdesc'}
      ]);
    ...
    store.load({params:{start:0, limit:<%=pageSize%>}});
      ...
      //selected grid
          ...
          var cm1 = new Ext.grid.ColumnModel([{header: "资源名称", sortable: false,  dataIndex: 'resname'}
          ,action]);
...
<div id="pagemenubar" style="z-index:100;"></div> 
    <form action="<%= request.getContextPath()%>/base/security/sysresource/sysresourcebrowserm.jsp" name="EweaverForm" id="EweaverForm"  method="post">
