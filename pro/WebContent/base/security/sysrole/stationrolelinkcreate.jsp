...
<div id="pagemenubar" style="z-index:100;"></div>
 <form action="<%= request.getContextPath()%>/ServiceAction/com.eweaver.base.security.servlet.UserroleAction?action=createstation" name="EweaverForm"  method="post">
	...
	<colgroup> 
	 ...
	 <tr>
	    <td class="FieldName" nowrap>
			<%=labelService.getLabelName("402881e510e569090110e56e72330003")%><!-- 岗位名称-->
	   </td>
	   <td class="FieldValue">
	         <button  type="button" class=Browser onclick="javascript:getBrowser('/humres/base/stationbrowser.jsp','userid','useridspan','1');"></button>
	 ...
	 <tr>
	   ...
	   <td class="FieldValue">
	         <!-- button  class=Browser onclick="javascript:getBrowser('/base/security/sysrole/sysrolebrowser.jsp','roleid','roleidspan','1');"></button> -->
