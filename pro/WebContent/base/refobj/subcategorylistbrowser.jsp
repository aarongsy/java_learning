...
<%
      String action=request.getContextPath()+"/ServiceAction/com.eweaver.base.category.servlet.CategoryAction?action=subcalist";
%>
 <%
...
<html>
  ...
  <style type="text/css">
    ...
    <%}%>
        ...
        var cm = new Ext.grid.ColumnModel([{header: "表单名称", sortable: false,  dataIndex: 'objname'}
