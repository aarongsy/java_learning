...
<script type="text/javascript">
    ...
    orgTree = new Ext.tree.TreePanel({
            ...
            loader:new Ext.tree.TreeLoader({
                dataUrl: "<%=request.getContextPath()%>/ServiceAction/com.eweaver.base.orgunit.servlet.OrgunitTreeAction?action=getChildrenExt&type=orgdef&sqlwhere=<%=sqlwhere%>",
...
<% session.setAttribute("isstation","0"); %>
  </body>
</html>