...
<iframe id="imgList" name="imgList" width="100%" height="100%"></iframe>
</div>
<!--页面菜单结束-->
...
<tr><%
for(String dir:dirs){
	out.println("<td><a onclick=\"show()\" target='imgList' href='imagesBrowser.jsp?p="+p+dir+"'>"+dir+"</a></td>");
}
 %><td><%if(!p.equalsIgnoreCase("/")){%><a onclick="show()" target="imgList" href="imagesBrowser.jsp?p=<%=pp%>">向上</a><%}%></td></tr>
</table>
</div>
