...
if(StringHelper.isEmpty(rvalue)){
	rvalue = StringHelper.null2String(request.getParameter("rvalue"));
}
...
<form action="<%=request.getContextPath()%>/ServiceAction/com.eweaver.base.lics.servlet.LicsAction?action=licsin" name="EweaverForm"  method="post">
	<tr height=10>
