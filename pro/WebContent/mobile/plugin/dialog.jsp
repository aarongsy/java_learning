...
<head>
	...
	<script type="text/javascript" src="/mobile/plugin/1/js/jquery.min.js"></script>
	<style type="text/css">
	.searchText {
		width:100%;
		height:20px;
	...
	<%
	String returnShowField = StringHelper.null2String(request.getParameter("returnShowField"));
	String returnIdField = StringHelper.null2String(request.getParameter("returnIdField"));
	boolean isMuti = "1".equals(StringHelper.null2String(request.getParameter("isMuti"))) ? true : false;
	String requestid = StringHelper.null2String(request.getParameter("requestid"));
	String nodeid = StringHelper.null2String(request.getParameter("nodeid"));
	String browserTypeId = StringHelper.null2String(request.getParameter("browserId"));
...
<div data-role="page" class="page" style="background:#F0F0F0;margin:0;padding-left:10px;padding-right:10px;padding-top:10px;padding-bottom:10px;height:auto !important;">
