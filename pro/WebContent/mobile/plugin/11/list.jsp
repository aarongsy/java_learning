		    	...
		    	if(data.error){
					...
					$.each(data.attentionList, function (i, item){ 
						...
						listItemString=listItemString+"<div class='listitem' onclick='javascript:showItemDetailed();'>"
									...
									+"								<img src='images/blog/new.png' width='20' style='display:"+(isnew=="1"?"":"none")+"'>"
									+"							</TD>"
									+"						</TR>"
									+"					</TABLE>"
									+"				</div>"
			...
			<div class="navbtnblock">
				<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;color:#395582;">
					<tr>
						...
						<td width="25%" align="center">
							<div class="navbtn navbtnslt" url="/mobile/plugin/11/list.jsp?module=<%=request.getParameter("module")%>&scope=<%=request.getParameter("scope")%>&userid=<%=request.getParameter("userid")%>">
