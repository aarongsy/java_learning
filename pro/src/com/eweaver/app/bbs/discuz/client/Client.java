package com.eweaver.app.bbs.discuz.client;
...
public class Client extends PHPFunctions
{
  ...
  public static String UC_API = "http://localhost:8686/ucenter";
  public static String UC_CONNECT = "";
  public static String UC_KEY = "1234567890";
  ...
  public static String UC_PASSWORD = "123456";
  public static String BBS_API = "http://localhost:8686/bbs/";
  ...
  {
    return uc_user_register($username, $password, $username + "@163.com", "", "");
  }
  ...
  {
    String $return = uc_api_post("user", "synlogout", new HashMap());
    return $return;
  }
  ...
  static
  {
    ...
    try {
      ...
      UC_PASSWORD = properties.getProperty("UC_PASSWORD");
      BBS_API = properties.getProperty("BBS_API");
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
