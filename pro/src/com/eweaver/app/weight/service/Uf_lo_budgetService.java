...
import com.eweaver.app.weight.model.Uf_lo_budget;
import com.eweaver.app.weight.model.Uf_lo_budgetdetail;
...
public class Uf_lo_budgetService
{
  public int createBudget(Uf_lo_budget budget, List<Uf_lo_budgetdetail> details, String merges, String lx, String p50, String reqman)
  {
    int ret = 0;
    ...
    for (int i = 0; i < details.size(); i++) {
      ...
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getRowindex())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getChargecode())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getSubject())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getAmount())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getNotaxamount())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getSaletax())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getCostcentre())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getPurchorder())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getSaleorder())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getItemno())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getProjecttext())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getIsflag())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getDetailid())).append("',");
      buffer.append("'").append(StringHelper.null2String(((Uf_lo_budgetdetail)details.get(i)).getWlh())).append("')");
  ...
  //2016-10-02 传入提单号 ，校验该提单号已生成暂估明细 不在生成
	public int createBudget(Uf_lo_budget budget, List<Uf_lo_budgetdetail> details, String merges, String lx, String p50, String reqman,String plate)
  {
    int ret = 0;
    BaseJdbcDao baseJdbc = (BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
  ...
  public String getRequestidByLadingno(String ladingno)
  {
    ...
    ret = StringHelper.null2String(ds.getValue("select p.requestid from uf_lo_loadplan p left join uf_lo_ladingmain l on p.reqno = l.loadingno where l.ladingno = '" + ladingno + "'"));
    return ret;
  }
 ...
 //2016-10-02 传人提单号
  ...
  {
    int ret = 0;
    Uf_lo_budget budget = new Uf_lo_budget();
    BaseJdbcDao baseJdbc = (BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
    DataService ds = new DataService();
    ...
    if ((list1 != null) && (list1.size() > 0)) {
      ...
      for (int j = 0; j < mxids.size(); j++)
      {
        ...
        for (int i = 0; i < list2.size(); i++) {
          ...
          Uf_lo_budgetdetail detail = new Uf_lo_budgetdetail();
  ...
  public int createBudgetByPlan(String requestid)
  {
    int ret = 0;
    Uf_lo_budget budget = new Uf_lo_budget();
    BaseJdbcDao baseJdbc = (BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
    ...
    if ((list1 != null) && (list1.size() > 0)) {
      ...
      for (int j = 0; j < mxids.size(); j++)
      {
        ...
        String lx = "zc";
        ret += createBudget(budget, details, merge, lx, p50, reqman);
      }
    }
    return ret;
  }

  public int createBudgetByAberrant(String requestid)
  {
    int ret = 0;
    Uf_lo_budget budget = new Uf_lo_budget();
    BaseJdbcDao baseJdbc = (BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
    ...
    if ((list1 != null) && (list1.size() > 0)) {
      ...
      budget.setInvoicestatue(
        StringHelper.null2String("402864d149e039b10149e080b01600c0"));
      ...
      budget.setFeetype("40285a8d4d6fab42014d742812381731");

      String sqlmxids = "select wm_concat(p.id) ids,get_merge(p.id) merge,materialno,ordertype,costenter,cardetailid from uf_lo_loaddetail p where requestid = '" + requestid + "' group by get_merge(p.id),materialno,ordertype,costenter,cardetailid";
      List mxids = ds.getValues(sqlmxids);
      String merge = "";
      String merges = "";
      ...
      for (int j = 0; j < mxids.size(); j++)
      {
        ...
        String sqlsum = "select nvl(sum(uf_lo_loaddetail.divvyexpfee), 0) fare,decode(nvl(sum(uf_lo_loaddetail.divvyexpfee) * 100 / (" + 
          prnum + "), 0)," + 
          "0," + 
          "'0.00'," + 
          "to_char(nvl(sum(uf_lo_loaddetail.divvyexpfee) * 100 / (" + prnum + ")," + 
          "0)," + 
          "'9999999999.99')) axfare " + 
          "from uf_lo_loaddetail " + 
          "where instr('" + StringHelper.null2String(idsMap.get("ids")) + "', uf_lo_loaddetail.id) > 0";
        ...
        String costcenter = "";
        String costcentre = StringHelper.null2String(idsMap.get("costenter"));
        List list001 = ds.getValues("select costcentre from uf_lo_costcentre where requestid = '" + costcentre + "'");
        if (list001.size() > 0) {
          Map map001 = (Map)list001.get(0);
          costcenter = StringHelper.null2String(map001.get("costcentre"));
        }
        ...
        String sql2 = "select d.*,nvl(d.divvyexpfee,0) dtax,decode(nvl(d.divvyexpfee * 100/(" + 
          prnum + "), 0),0,'0.00',to_char(nvl(d.divvyexpfee * 100/(" + prnum + "),0),'9999999999.99')) dfee," + 
          "(select max(orderno) from v_lo_order where v_lo_order.runningno = d.runningno) orderno," + 
          "(select max(items) from v_lo_order where v_lo_order.runningno = d.runningno) items," + 
          "(select max(saleno) from v_lo_order where v_lo_order.runningno = d.runningno) saleno," + 
          "(select max(salesitem) from v_lo_order where v_lo_order.runningno = d.runningno) salesitem," + 
