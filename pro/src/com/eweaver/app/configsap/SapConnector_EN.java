...
public class SapConnector_EN
{
  public static Hashtable<String, JCoDestination> destinations = new Hashtable();
  public static final String fdPoolName = "sanpowersapen";
    ...
    throws Exception
  {
    ...
    InputStream is = SapConnector_EN.class
      .getResourceAsStream("/sap-config_EN.properties");
    sapConfig.load(is);

    createDataFile("sanpowersapen", "jcoDestination", sapConfig);
  }
    ...
    throws Exception
  {
    ...
    JCoFunctionTemplate template = getRfcTemplate(rfcName, "sanpowersapen");
    if (template != null) {
