...
public class SelPurchase_ZOA_MM_PO_INFO_MM
{
  public String functionname;

  public static void main(String[] str)
  {
    SelPurchase_ZOA_MM_PO_INFO_MM app = new SelPurchase_ZOA_MM_PO_INFO_MM("ZOA_MM_PO_INFO_EN");
    app.getDetailData("");
  }

  public SelPurchase_ZOA_MM_PO_INFO_MM(String functionname)
  {
  ...
  public List<SelPurDetail> getDetailData(String ebeln)
  {
    ...
    try
    {
      ...
      String functionName = "ZOA_MM_PO_INFO_EN";
