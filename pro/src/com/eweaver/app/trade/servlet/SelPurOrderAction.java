...
import com.eweaver.app.trade.service.SelPurDetail;
import com.eweaver.app.trade.service.SelPurchase_ZOA_MM_PO_INFO;
...
public class SelPurOrderAction
  implements AbstractAction
{
  ...
  public SelPurOrderAction(HttpServletRequest request, HttpServletResponse response)
  {
  ...
  public void execute() throws IOException, ServletException
  {
    ...
    if (action.equals("search")) {
      SelPurchase_ZOA_MM_PO_INFO app = new SelPurchase_ZOA_MM_PO_INFO(
        "ZOA_MM_PO_INFO");
      ...
      if (ebeln.trim().length() > 0) {
        ...
        if (orderlist != null) {
          for (int i = 0; i < orderlist.size(); i++) {
            ...
            selpurdetail = (SelPurDetail)orderlist.get(i);
