...
import com.eweaver.app.trade.service.SelSODetail;
import com.eweaver.app.trade.service.SelSaleOrder_ZOA_SD_SO_INFO;
...
public class SelSaleOrderAction
  implements AbstractAction
{
  ...
  public SelSaleOrderAction(HttpServletRequest request, HttpServletResponse response)
  {
  ...
  public void execute() throws IOException, ServletException
  {
    ...
    if (action.equals("search")) {
      SelSaleOrder_ZOA_SD_SO_INFO app = new SelSaleOrder_ZOA_SD_SO_INFO(
        "ZOA_SD_SO_INFO");
      ...
      if (vbeln.trim().length() > 0) {
        ...
        if (orderlist != null) {
          for (int i = 0; i < orderlist.size(); i++) {
            ...
            selsodetail = (SelSODetail)orderlist.get(i);
