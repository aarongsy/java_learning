...
public class ReadNMBJExcel 
	implements AbstractAction
	{
	  ...
	  public ReadNMBJExcel(HttpServletRequest request, HttpServletResponse response)
	  {
	    ...
	    throws IOException, ServletException
	  {
	    ...
	    is.close();
	    ImportNMBJExcel importData = new ImportNMBJExcel();
	    ...
	    if (file2.isFile())
	      file2.delete();
	    String url = this.request.getContextPath() + "/app/exceltest/nmbjExcelLoad.jsp?requestid="+requestid+"&throwstr="+throwstr;
