...
public class ReadBJExcel 
	implements AbstractAction
	{
	  ...
	  public ReadBJExcel(HttpServletRequest request, HttpServletResponse response)
	  {
	    ...
	    throws IOException, ServletException
	  {
	    ...
	    System.out.println("attach :" + attach.getFiledir());
	    System.out.println("attach id :" + attach.getId());
	    ...
	    is.close();
	    ImportBJExcel importData = new ImportBJExcel();
	    ...
	    //if (file2.isFile())
	     // file2.delete();
	    String url = this.request.getContextPath() + "/app/exceltest/bjExcelLoad.jsp?requestid="+requestid+"&throwstr="+throwstr;
