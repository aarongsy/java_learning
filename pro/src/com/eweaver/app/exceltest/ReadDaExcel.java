...
public class ReadDaExcel
	implements AbstractAction
	{
	  ...
	  public ReadDaExcel(HttpServletRequest request, HttpServletResponse response)
	  {
	    ...
	    throws IOException, ServletException
	  {
	    ...
	    is.close();
	    ImportExcelService importData = new ImportExcelService();
	    ...
	    if (file2.isFile())
	      file2.delete();
	    String url = this.request.getContextPath() + "/app/exceltest/ExcelLoad.jsp?requestid="+requestid+"&throwstr="+throwstr;
