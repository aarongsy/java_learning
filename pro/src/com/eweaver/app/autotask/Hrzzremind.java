...
public class Hrzzremind {
	  public void doAction()
	  {
	    BaseJdbcDao baseJdbc = (BaseJdbcDao)BaseContext.getBean("baseJdbcDao");

		String sql = "select a.requestid,a.objdept,a.objcom,a.objgroup,a.comtype,a.safelevel,a.first,a.second,a.objecttype,a.supplycode,a.khcode,b.psnno from uf_hr_businesstripsub a inner join uf_hr_businesstrip b on a.requestid = b.requestid where b.isvalided = '40288098276fc2120127704884290210' and 1<>(select isdelete from requestbase where id = b.requestid) and 1=(select isfinished from requestbase where id = b.requestid)";
		sql = sql +" and (select to_date(tochar(sysdate,'yyyy-mm-dd'),'yyyy-mm-dd') from dual) >= to_date(to_char(to_date(edate,'yyyy-mm-dd')+7,'yyyy-mm-dd'),'yyyy-mm-dd')";
