...
<%
    ...
    if (!"".equals(yddzdh)){
        stringBuffer
				...
				.append(" T2.plannotaxacount,T2.WEIGHT,")
                .append(" t2.DJBH,")
                .append(" T2.handingplancode,")
                .append(" T2.SAPPZBH,")
                .append(" T2.COSTTYPE,")
                .append(" (SELECT conname from uf_dmlo_consolidat where id=T2.CARRIERNAME) CARRIERNAME,")
                .append(" t2.TRANSDATE,")
                .append(" T2.CARTYPE,")
                .append(" T2.PLATENUM,")
                .append(" T2.LOCATION,")
                ...
                .append(" T2.hl,")
                .append(" t2.DJBH,")
				.append(" t2.DJBH,t2.shipping,t2.ordercode orderno,t2.proclass product,")
                .append(" T2.SAPPZBH ")
                .append("FROM ")
        ...
        while (rs.next()){
			...
			String shipping= Util.null2String(rs.getString("shipping"));//shipping
			String orderno= Util.null2String(rs.getString("orderno"));//订单号
			String product= Util.null2String(rs.getString("product"));//产品
