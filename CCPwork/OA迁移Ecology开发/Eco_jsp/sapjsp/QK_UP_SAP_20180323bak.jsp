...
<%
	...
	try {
		...
		StringBuffer sqllist=new StringBuffer()
				...
				.append("where t1.id=t2.mainid and t1.zt!='5' and t1.yddzd='"+yddzd+"' and t1.sqbh='"+sqbh+"' order by t2.id");
		StringBuffer headerSql = new StringBuffer().append("select * from uf_qkqz where zt!='5' and yddzd='" + yddzd + "' and sqbh='"+sqbh+"'");
