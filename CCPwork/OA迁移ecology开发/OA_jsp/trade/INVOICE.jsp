...
<table width="100%%" border="0" cellpadding="0" cellspacing="0">
  ...
  if ("来料加工订单(加工费)".equals(ordertypedes) ) {  
	...
	*/
	    //2017-06-15 16:11 xxy 修改为取报关数量* 净价
		jgfeestr = StringHelper.null2String(ds.getSQLValue("select NVL(sum(quantity*price),0)  from uf_tr_declaration where requestid='"+requestid+"'"));
		jgfeestr = df.format(NumberHelper.string2Double(jgfeestr));
