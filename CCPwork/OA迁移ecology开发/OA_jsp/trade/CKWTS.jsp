...
<body>
	...
	<table width="100%%" border="1" cellspacing="0" cellpadding="0" class="header" style="border-right:0px solid black;border-top:0px solid black;">
		...
		<tr>
			...
			<td rowspan="4" colspan="2" valign="top" ><SPAN class="STYLE3">中英文品名：</SPAN><br />
				<textarea id="zywpm" class="input_txt" index="3" style="overflow-y:hidden;width:100%;height:140px;border: 0px;font-size:12px/0.75em;font-family:'Arial','SimSun','Microsoft YaHei';"><%=goodsgroup %></textarea>
			</td>
		</tr>
	</table>
	...
	<TBODY>
		<tr>
			...
			<td width="30%" align="center" style="border-top:0px solid black;"><SPAN class="STYLE3">中英文品名</SPAN></td-->
		...
		<tr>
			...
			<textarea id="zywpm" class="input_txt" index="3" style="overflow-y:hidden;width:100%;height:150px;border: 0px;font-size:12px/0.75em;font-family:'Arial','SimSun','Microsoft YaHei';"><%=goodsgroup %></textarea>
			</td-->
			<td style="border-bottom:0px solid black;" >
				<input align="center" id="packtxt" style="width:100%;border: 0px;font-size:12px/0.75em;font-family: font-family:'Arial','SimSun','Microsoft YaHei';"  type="text" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=packtotal %>&nbsp; 包" />
				<select id="packid" name="select" style="width:100%;height30px;font-size=24px;font-family:font-family:'Arial','SimSun','Microsoft YaHei';" onchange="chgpack();">
					...
					<option value="<%=packtotal %>&nbsp; PACKAGE"><%=packtotal %>&nbsp; PACKAGE</option>
					<option value="<%=packtotal %>&nbsp; IN BULK"><%=packtotal %>&nbsp; IN BULK</option>
				</select>				
 ...
 <%
 //String sql1 = "select  u1.cabtype,(select objname from selectitem where id=u1.isdager) isdagerdes,u1.cabno,count(*) cabnums from uf_tr_packtype u1 where u1.requestid = '"+requestid+"' group by u1.cabtype,u1.isdager,u1.cabno";
 //String sql1 = "select  u1.cabtype,u1.cabno,count(*) cabnums from uf_tr_packtype u1 where u1.requestid = '"+requestid+"' group by u1.cabtype,u1.cabno"; //2016-02-14 xxy 修改
 ...
 %>
	<table width="100%%" border="1" align="center" cellpadding="0" cellspacing="0" class="footer" style="border-right:0px solid black;">
		...
		<tr>
			...
			<!--td width="51%" align="left"><textarea style="overflow-y:hidden;width:100%;height:20px;border: 0px;font-size:12px/0.75em;font-family:'Arial','SimSun','Microsoft YaHei'">柜型：<%=cabtype %></textarea></td-->			
		...
		<tr>
			...
			<!--td colspan="2" align="left"><textarea style="overflow-y:hidden;width:100%;height:20px;border: 0px;font-size:12px/0.75em;font-family:'Arial','SimSun','Microsoft YaHei'">柜数：<%=cabtypenums %></textarea></td-->
		</tr>
		<tr>
