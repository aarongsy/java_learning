...
if(newretTable.getNumRows() >0)
{
	for(int j = 0;j<newretTable.getNumRows();j++)
	{
		...
		//{
			...
			int no = j+1;
			String insql = "insert into uf_tr_feenocleatsub(id,requestid,sno,custsuppflag,custsuppcode,ledgerflag,clearreceiptid,fiscalyear,clearreceiptitem,surplusmoney,cleartext,rmbamount)values('"+IDGernerator.getUnquieID()+"','"+requestid+"','"+no+"','S','"+HKONT+"','"+UMSKZ+"','"+BELNR+"','"+GJAHR+"','"+BUZEI+"','"+WRBTR+"','"+SGTXT+"','"+DMBTR+"')";
