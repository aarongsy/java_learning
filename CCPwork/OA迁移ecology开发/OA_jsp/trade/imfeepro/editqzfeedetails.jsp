...
if(sublist.size()>0){
	...
	%>
		...
		<TD   class="td2"  align=center><input type="hidden" id="<%="estmoney_"+no %>" value="<%=estmoney %>"><span id="<%="estmoney_"+no+"span" %>"><%=estmoney %></span></TD>
		
		<TD   class="td2"  align=center><%=estrate %></TD>
		<TD   class="td2"  align=center><input type="hidden" id="<%="estamount_"+no %>" value="<%=estamount %>"><span id="<%="estamount_"+no+"span" %>"><%=estamount %></span></TD>


		<TD   class="td2"  align=center><input type="text" id="<%="qzmon_"+no %>" value="<%=qzmon %>" onblur="changeqzje  ('<%=no%>')"></TD>
		<TD   class="td2"  align=center><input type="hidden" id="<%="qzrmbmon_"+no %>" value="<%=qzrmbmon %>"><span id="<%="qzrmbmon_"+no+"span" %>"><%=qzrmbmon %></span></TD>

		<TD   class="td2"  align=center><input type=hidden id="<%="ywhbce_"+no %>" value="<%=buscurrencydiff%>"><span id="<%="ywhbce_"+no+"span" %>" ><%=buscurrencydiff %></span></TD>
		<TD   class="td2"  align=center><input type=hidden id="<%="bwbce_"+no %>" value="<%=currencydiff %>"><span id="<%="bwbce_"+no+"span" %>"><%=currencydiff %></span></TD>
