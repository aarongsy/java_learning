...
'pono','poitem','wlh','shorttxt','quantity','unit','shipdate','price','currency','amount','cgsqtype','cgsqorder','cgsqitem','qgquan','baseunit','inorder','assetno','kmfp','taxcode','taxprice','ordertype','ordertypedes','supcode','supname','paytermcode','paytermdesc','icon1','icon1desc','icon2','ordercur','rate','orderdate','totalamt','totaltaxamt','comcode','company','pzflag','pudate'
        var reqid=rec.get('pono')+'^@^'+rec.get('poitem')+'^@^'+rec.get('wlh')+'^@^'+rec.get('shorttxt')+'^@^'+rec.get('quantity')+'^@^'+rec.get('unit')+'^@^'+rec.get('shipdate')+'^@^'+rec.get('price')+'^@^'+rec.get('currency')+'^@^'+rec.get('amount')+'^@^'+rec.get('cgsqtype')+'^@^'+rec.get('cgsqorder')+'^@^'+rec.get('cgsqitem')+'^@^'+rec.get('qgquan')+'^@^'+rec.get('baseunit')+'^@^'+rec.get('inorder')+'^@^'+rec.get('assetno')+'^@^'+rec.get('kmfp')+'^@^'+rec.get('taxcode')+'^@^'+rec.get('taxprice')+'^@^'+rec.get('ordertype')+'^@^'+rec.get('ordertypedes')+'^@^'+rec.get('supcode')+'^@^'+rec.get('supname')+'^@^'+rec.get('paytermcode')+'^@^'+rec.get('paytermdesc')+'^@^'+rec.get('icon1')+'^@^'+rec.get('icon1desc')+'^@^'+rec.get('icon2')+'^@^'+rec.get('ordercur')+'^@^'+rec.get('rate')+'^@^'+rec.get('orderdate')+'^@^'+rec.get('totalamt')+'^@^'+rec.get('totaltaxamt')+'^@^'+rec.get('comcode')+'^@^'+rec.get('company')+rec.get('pzflag')+'^@^'+rec.get('pudate');
