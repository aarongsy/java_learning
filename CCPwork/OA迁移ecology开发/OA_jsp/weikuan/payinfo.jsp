...
<%
	...
	if (action.equals("getData")){
		...
		BaseJdbcDao baseJdbc=(BaseJdbcDao)BaseContext.getBean("baseJdbcDao");
			...
			//function.getImportParameterList().setValue("ZTERM","AA");
			...
			//更新数据库中对应的行项信息
			String upsql="delete uf_fn_acceptpayinfo where requestid='"+requestid+"'";
			System.out.println(upsql);
			baseJdbc.update(upsql);
			upsql = "insert into uf_fn_acceptpayinfo (id,requestid,compcode,pznumber,year,paymoney,pzcurrency,subject,payterm,payway,jzdate,forzenpay,blank,text) values((select sys_guid() from dual),'"+requestid+"','"+BUKRS+"',"+BELNR+",'"+GJAHR+"','"+WRBTR+"','"+PSWSL+"','"+HKONT+"','"+ZTERM+"','"+ZLSCH+"','"+ZFBDT+"','"+ZLSPR+"','"+BVTYP+"','"+SGTXT+"')";
			baseJdbc.update(upsql);
			System.out.println(upsql);
			System.out.println(orderno);
				...
				String upsql = "insert into uf_fn_acceptpayinfo (id,requestid,compcode,pznumber,year,paymoney,pzcurrency,subject,payterm,payway,jzdate,forzenpay,blank,text) values((select sys_guid() from dual),'"+requestid+"','"+BUKRS+"',"+BELNR+",'"+GJAHR+"','"+WRBTR+"','"+PSWSL+"','"+HKONT+"','"+ZTERM+"','"+ZLSCH+"','"+ZFBDT+"','"+ZLSPR+"','"+BVTYP+"','"+SGTXT+"')";
					baseJdbc.update(upsql);
