...
<%
	...
	if(!tmpfinan.equals(""))
	{
		if(tmpfinan.equals("40285a8d4fbaabf8014fbf03219615cc"))
		{
		  ...
		  String functionName = "ZOA_MM_COMPLAIN_IN";//抱怨写入(执行财务端解冻操作)
		  ...
		  try
		  {
			 ...
			 function.getImportParameterList().setValue("ZFLAG1"," ");//财务端
			...
			if(!backmark.equals(""))
			{
				...
				{
					//更新数据库
					String sql="update uf_oa_purcomplain set finanfrozen='40285a8d4fbaabf8014fbf03219615cd' where requestid='"+requestid+"'";
