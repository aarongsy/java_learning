...
String sql ="";
	...
	sql= "select sno,lineno,linename,linetype,trantype,hxarea,qygang,gycity,mdgang,mdcity,vehicle,gx,danger,dangerlv,pritype,stone,etone,requir,pro,gl,sl,timee,price,baojia,curr,boat,zdprice,gxfee from uf_lo_yijiadetail a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	...
	<TR><TD class="td2" colspan="15">没有信息</TD></TR>
<%} %>
</table>
</div>
