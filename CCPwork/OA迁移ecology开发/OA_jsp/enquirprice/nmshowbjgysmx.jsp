...
String sql ="";
	...
	sql= "select id,sno,(select objno from humres where id=supcode)as supcode,supname,supacc,(select objname from selectitem where id=isbj)as isbj,pm,hxarea from uf_lo_bijiasup a where a.requestid='"+requestid+"' order by a.sno asc";
