...
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;供应商简码&nbsp;&nbsp;</TD>
...
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;本期每柜合计&nbsp;&nbsp;</TD>
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;预估柜量&nbsp;&nbsp;</TD>
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;较上期最优价涨（+）跌（-）金额USD&nbsp;&nbsp;</TD>
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;较上期总涨跌幅金额USD&nbsp;&nbsp;</TD>
</TR>
<TR height="25"  class="title">
...
<TD  noWrap class="td2"  align=center>FREE TIME 21 DAYS&#10;额外费用</TD>
<TD  noWrap class="td2"  align=center>FREE TIME 30 DAYS&#10;额外费用</TD>
<TD  noWrap class="td2"  align=center>FREE TIME 45 DAYS&#10;额外费用</TD>
<TD  noWrap class="td2"  align=center>FREE TIME 60 DAYS&#10;额外费用</TD>
...
String sql ="";
	...
	sql= "select sno,gx,isdanger,dengerllv,hxarea,hx,qygang,mdgang,equair,pro,hyfee,gxfee,baf,yas,gbf,caf,ebs,cic,ens,ams,rcs,pss,days21,days30,days45,days60,shipcom,shipdate,(select objno from humres where id=supcode)supcode,supname,gsum,gl,addusd,addfl from uf_tr_bijiadetail  a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		String addusd=StringHelper.null2String(mk.get("addusd"));
		String addfl=StringHelper.null2String(mk.get("addfl"));
	...
	%>
		...
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=rcs%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=pss%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=days21%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=days30%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=days45%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=days60%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=shipcom%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=shipdate%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=gsum%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=gl%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=addusd%>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=addfl%>&nbsp;&nbsp;</TD>
		</TR>
	<%
		}
