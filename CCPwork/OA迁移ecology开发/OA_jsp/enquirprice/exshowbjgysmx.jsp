...
<div id="warpp"  >
<table id="gysdataTable" style="BORDER-COLLAPSE: collapse" border=1 cellSpacing=0 cellPadding=0   style="width: 100%;font-size:12" bordercolor="#adae9d">
<COLGROUP>
<COL width="20%">
<COL width="20%">
<COL width="20%">
...
<TD  noWrap class="td2"  align=center >&nbsp;&nbsp;是否参与报价&nbsp;&nbsp;</TD>
</TR>
<%

String sql ="";

	sql= "select id,sno,(select objno from humres where id=supcode)as supcode,supname,supacc,(select objname from selectitem where id=isbj)as isbj,pm,hxarea from uf_tr_bijiasup a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		String isbj=StringHelper.null2String(mk.get("isbj"));
	...
	%>
		...
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=supcode %>&nbsp;&nbsp;</TD>
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<%=isbj %>&nbsp;&nbsp;</TD>
	...
	<TR><TD class="td2" colspan="5">没有信息</TD></TR>
<%} 
