...
String sql ="";
	...
	sql= "select id,sno,(select objno from humres where id=supcode)as supcode,supname,supacc,pm,hxarea,gxty from uf_lo_bijiahx a where a.requestid='"+requestid+"' order by a.sno asc";
