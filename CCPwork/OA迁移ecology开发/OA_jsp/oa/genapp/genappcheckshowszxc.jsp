...
<%
       ...
       if(sublist.size()>0){
			  ...
			  String bikecode=StringHelper.null2String(mk.get("bikecode"));
			  int nosent=0;
		...
		%>
			...
			<TD noWrap class="td2"  align=center><%=bikecode %></TD>
