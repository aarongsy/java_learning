...
<%
	String sql="select a.no as no1,a.goodsname as goodsno,a.goods as goodsname,a.reqname as applyer,(select objname from humres where id=a.reqname) as applyname,a.reqdept as deptid,(select objname from orgunit where id=a.reqdept) as deptname,a.company as comid,(select objname from orgunit where id=a.company) as compname,a.goodstyle,(select objname from selectitem where id=a.goodstyle) as stylename,a.sepcify as specify,a.unit,a.price,a.reqnum as num,a.supplier as spna,(select supplyname from uf_oa_supplyinfo where requestid=a.supplier) as supplyname,a.supplierid as scode,a.excptdate,a.reqdate as needdate,a.address,(select appnumber from uf_oa_generalsuppapp where requestid= a.genappno) as  appnumber,a.genappcolumnno as no, a.ledgersubj  as subject,(select subject from uf_oa_feesubject where  requestid=a.ledgersubj) as subjectname,(select innerorder from uf_oa_innerorderno where requestid=a.inorder) as innerorder, a.inorder as innerid,a.category cate,(select columnname from uf_oa_gensplcategory where requestid=a.category) as catename,a.subcate,(select columnname from uf_oa_gensplcategory where requestid=a.subcate) as subcatename,a.genappno as appno,a.remark,a.ordernum,(select objname from humres where id=(select psn from uf_oa_goodsdetailapp  where requestid=a.genappno and no=a.genappcolumnno )) as psn,(select taxcode  from uf_oa_taxcode where requestid=a.taxcode) as codename,a.taxcode,(select objname from selectitem where id=a.taxstyle) taxtypename,a.taxstyle,a.taxrate from uf_oa_genorderdetailapp a where requestid='"+requestid+"' order by a.no asc";
       ...
       if(sublist.size()>0){
			  ...
			  String psn=StringHelper.null2String(mk.get("psn"));
			  ...
			  String taxtype=StringHelper.null2String(mk.get("taxstyle"));
			  String codename=StringHelper.null2String(mk.get("codename"));;
			  String taxtypename=StringHelper.null2String(mk.get("taxtypename"));;
...
<TD noWrap><span ><input type="checkbox" name="check_node_40285a8f489c17ce0148f405a13278b8" value="<%=k%>"><input type=hidden name=<%="detailid_40285a8f489c17ce0148f405a13278b8_"+k %> value=""></span><input type="hidden" id=<%="field_40285a8f489c17ce0148f42104807b9c_"+k %> name=<%="field_40285a8f489c17ce0148f42104807b9c_"+k %> value="<%=no1%>" maxlength=24  ><span style='width: 40.62%; height: 19px' id=<%="field_40285a8f489c17ce0148f42104807b9c_"+k+"span" %> name=<%="field_40285a8f489c17ce0148f42104807b9c_"+k+"span" %> ><%=no1%></span></TD>
...
<TD noWrap><input type="hidden"  value="<%=psn%>" ><span   style='width: 80%; height: 19px' ><%=psn%></span></TD>
...
<TD noWrap><input type="hidden" class="InputStyle2" name=<%="field_40285a8f489c17ce0148f42105697bac_"+k%>  id=<%="field_40285a8f489c17ce0148f42105697bac_"+k%> value="<%=price%>"  style='width: 80%; height: 19px' ><span id=<%="field_40285a8f489c17ce0148f42105697bac_"+k+"span"%> name=<%="field_40285a8f489c17ce0148f42105697bac_"+k+"span"%> ><%=price%></span></TD>
...
<TD noWrap><button type=button  style="display:none" class=Browser id=<%="button_40285a8f489c17ce0148f42105a47bb0_"+k%> name=<%="button_40285a8f489c17ce0148f42105a47bb0_"+k%> onclick="javascript:getrefobj('<%="field_40285a8f489c17ce0148f42105a47bb0_"+k%>','<%="field_40285a8f489c17ce0148f42105a47bb0_"+k+"span"%>','40285a8f48988ad501489d1a4dc6023e','sqlwhere=classify=%2740285a8f489c17ce0148a0fd7dbe0a6a%27 ','','1');"></button><input type="hidden" id=<%="field_40285a8f489c17ce0148f42105a47bb0_"+k%> name=<%="field_40285a8f489c17ce0148f42105a47bb0_"+k%> value="<%=spna%>" ><span id=<%="field_40285a8f489c17ce0148f42105a47bb0_"+k+"span"%> name=<%="field_40285a8f489c17ce0148f42105a47bb0_"+k+"span"%> ><%=supplyname%></span></TD>
<TD noWrap><input type="hidden" id=<%="field_40285a8f489c17ce0148f42105bb7bb2_"+k%> name=<%="field_40285a8f489c17ce0148f42105bb7bb2_"+k%> value="<%=excptdate%>"  style='width: 80%; height: 18px' class=inputstyle ><span id=<%="field_40285a8f489c17ce0148f42105bb7bb2_"+k+"span"%> name=<%="field_40285a8f489c17ce0148f42105bb7bb2_"+k+"span"%> ><%=excptdate%></span></TD>
...
<TD noWrap><input type="hidden" id=<%="field_40285a8f489c17ce0148f42106be7bc4_"+k%> name=<%="field_40285a8f489c17ce0148f42106be7bc4_"+k%>  value="<%=scode%>"  ><span style='width: 80%; height: 17px' id=<%="field_40285a8f489c17ce0148f42106be7bc4_"+k+"span"%> name=<%="field_40285a8f489c17ce0148f42106be7bc4_"+k+"span"%> ><%=scode%></span></TD>
		...
		<TD noWrap><button type=button style="display:none" class=Browser  id=<%="button_40285a8f489c17ce0148f42106dc7bc6_"+k%> name=<%="button_40285a8f489c17ce0148f42106dc7bc6_"+k%> onclick="javascript:getrefobj('<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k%>','<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k+"span"%>','40285a8f489c17ce0149075523563b8b','','','0');"></button><input type="hidden" id=<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k%> name=<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k%> value="<%=taxcode%>"  style='width: 80%; height: 17px' ><span id=<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k+"span"%> name=<%="field_40285a8f489c17ce0148f42106dc7bc6_"+k+"span"%> ><%=codename%></span></TD>
...
<TD noWrap><input type="hidden" id=<%="field_40285a8f489c17ce01490c34565a611e_"+k%> name=<%="field_40285a8f489c17ce01490c34565a611e_"+k%> value="<%=ordernum%>" maxlength=24  ><span style='width: 80%; height: 17px' id=<%="field_40285a8f489c17ce01490c34565a611e_"+k+"span"%> name=<%="field_40285a8f489c17ce01490c34565a611e_"+k+"span"%> ><%=ordernum%></span></TD>
...
<TD noWrap><input type="hidden" class="InputStyle2" name="field_40285a8f489c17ce0148f42105697bac_0"  id="field_40285a8f489c17ce0148f42105697bac_0" value=""  style='width: 80%; height: 19px'   ><span id="field_40285a8f489c17ce0148f42105697bac_0span" name="field_40285a8f489c17ce0148f42105697bac_0span" ><img src="/images/base/checkinput.gif" align=absMiddle></span></TD>
...
<TD noWrap><button type=button  class=Browser style="dispaly:none" id="button_40285a8f489c17ce0148f42105a47bb0_0" name="button_40285a8f489c17ce0148f42105a47bb0_0" onclick="javascript:getrefobj('field_40285a8f489c17ce0148f42105a47bb0_0','field_40285a8f489c17ce0148f42105a47bb0_0span','40285a8f48988ad501489d1a4dc6023e','sqlwhere= classify=%2740285a8f489c17ce0148a0fd7dbe0a6a%27 ','','1');supplierchange();"></button><input type="hidden" id="field_40285a8f489c17ce0148f42105a47bb0_0" name="field_40285a8f489c17ce0148f42105a47bb0_0" value=""     ><span id="field_40285a8f489c17ce0148f42105a47bb0_0span" name="field_40285a8f489c17ce0148f42105a47bb0_0span" ><img src="/images/base/checkinput.gif" align=absMiddle></span></TD>
<TD noWrap><input type="hidden" id="field_40285a8f489c17ce0148f42105bb7bb2_0" name="field_40285a8f489c17ce0148f42105bb7bb2_0" value=""  style='width: 80%; height: 18px' class=inputstyle size=10 onclick="WdatePicker()" ><span id="field_40285a8f489c17ce0148f42105bb7bb2_0span" name="field_40285a8f489c17ce0148f42105bb7bb2_0span" ><img src="/images/base/checkinput.gif" align=absMiddle></span></TD>
...
<TD noWrap><button type=button  class=Browser style="dispaly:none" id="button_40285a8f489c17ce0148f42106dc7bc6_0" name="button_40285a8f489c17ce0148f42106dc7bc6_0" onclick="javascript:getrefobj('field_40285a8f489c17ce0148f42106dc7bc6_0','field_40285a8f489c17ce0148f42106dc7bc6_0span','40285a8f489c17ce0149075523563b8b','','','0');"></button><input type="hidden" id="field_40285a8f489c17ce0148f42106dc7bc6_0" name="field_40285a8f489c17ce0148f42106dc7bc6_0" value=""  style='width: 80%; height: 17px'  ><span id="field_40285a8f489c17ce0148f42106dc7bc6_0span" name="field_40285a8f489c17ce0148f42106dc7bc6_0span" ></span></TD>
