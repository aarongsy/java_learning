...
<%
		...
		if(tlist.size()>0){
			...
			sql = "select jdpay,inneroeder,jznumber,innerno,subject,text,paydate,blank,taxcode,payway,num,saleorder,payterm,costcenter from uf_oa_feeclearpzdetail  t where t.requestid='"+requestid+"' order by to_number(no) asc";
