...
<%
	...
	if(action.equals("getData"))
	{
		...
		if(FLAG.equals("X"))
		{
			...
			String MTPOS = newretTable.getString("MTPOS");//销售项目类别组

			String CASNR = newretTable.getString("CASNR");//海关HS编码

			String upsql = "update uf_oa_fxqdgz set saperrinfo ='"+ERR_MSG+"',sapreturnflag='"+FLAG+"',saplrzx='"+PRCTR+"',sapwlhms='"+MAKTX+"'";
			upsql = upsql +",newsapwlh= '"+MATNR+"',comid= '"+WERKS+"',sapfxqd= '"+VTWEG+"',sapxsxmlbz= '"+MTPOS+"',saphghsbm= '"+CASNR+"'";
