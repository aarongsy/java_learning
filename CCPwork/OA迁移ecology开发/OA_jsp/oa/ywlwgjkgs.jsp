...
<%
	...
	if(action.equals("getData"))
	{
		...
		if(FLAG.equals("X"))
		{
			...
			String BERID = newretTable.getString("BERID");//MRP fw

			String VTWEG = newretTable.getString("VTWEG");//分销渠道



			String upsql = "update uf_oa_ywlwgjkgs set saperrinfo ='"+ERR_MSG+"',sapreturnflag='"+FLAG+"',sappl='"+DISLS+"',saplrzx='"+PRCTR+"',sapmz='"+BRGEW+"',sapwlhms='"+MAKTX+"',sapsrz='"+BSTRF+"' ";
			...
			upsql = upsql +",sapmrpz='"+DISGR+"',sapmrplx='"+DISMM+"',sapmrpkzz='"+DISPO+"',sapxszz='"+VKORG+"',sapwbcgcc='"+LGFSB+"',sapccdd='"+LGORT+"',sapsccc='"+LGPRO+"',sapbzjg= '"+BZJG+"',sapmrpqu= '"+BERID+"',sapfxqd= '"+VTWEG+"'";
			upsql = upsql +",sapaqkc='"+EISBE+"'";
