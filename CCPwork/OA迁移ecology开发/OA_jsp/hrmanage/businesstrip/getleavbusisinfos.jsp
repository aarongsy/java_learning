...
<%
	...
	if(list1.size()>0)
	{
		for(int m = 0;m<list1.size();m++)
		{
			...
			{
				if(zcbh.equals("A9")|| zcbh.equals("C7") || zcbh.equals("AA") || zcbh.equals("AB") || zcbh.equals("B1") || zcbh.equals("BJ") || zcbh.equals("CA") || zcbh.equals("B31")  || zcbh.equals("C0") || zcbh.equals("C1A") || zcbh.equals("CB") || zcbh.equals("AC"))
				{
