...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		String objname=StringHelper.null2String(mk.get("objname"));		//员工id
		String jobname=StringHelper.null2String(mk.get("jobname"));		//姓名
		String jobno=StringHelper.null2String(mk.get("jobno"));			//工号
	%>
		<TR id="<%="dataDetail_"+k %>">
		<TD   style="display:none"><input type="text" id="<%="theid_"+k%>" name="theid" value="<%=theid%>"></TD>
		<TD   class="td2"  align=center><span id="<%=("jobname_"+k+"span")%>"><%=jobname%></span></TD>
		<TD   class="td2"  align=center><span id="<%=("jobno_"+k+"span")%>"><%=jobno %></span></TD>
