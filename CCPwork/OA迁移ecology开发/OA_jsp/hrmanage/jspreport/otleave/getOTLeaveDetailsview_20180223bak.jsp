...
DataService ds = new DataService();
	...
	*/
	String sql = "";
	String nodesql = "select id,objname from nodeinfo where workflowid='40285a8f489c17ce014908333b744907' or workflowid='40285a904931f62b014936e72ccb2718'";
	...
	if( "3".equals(psntype) ) {	//常熟厂全厂主管查询
		humresidsql = humresidsql +" and extrefobjfield5='4028804d2083a7ed012083ebb988005b' ";
	}
	if( "4".equals(psntype) ) {	//长沙厂全厂主管查询
		humresidsql = humresidsql +" and extrefobjfield5='40285a90488ba9d101488bbdeeb30008' ";
	}
	if( "5".equals(psntype) ) {	//盘锦厂全厂主管查询
