...
<%
		...
		String ymd=df.format(new Date());
			...
			function.getImportParameterList().setValue("NOTESID",ymd);//NotesID
			 System.out.println(requestid+ymd);
			...
			for(int i = 0;i<list.size();i++)
			{
				...
				retTable.setValue("CL_MONEY",texttwo);//清账金额
				retTable.setValue("CL_TEXT",texttwo);//清帐文本	
