...
<%
	...
	if(ls.size()>0){
		for(int k=0 ; k<ls.size(); k++) 
		{
			...
			String sql2 = "insert into uf_hr_entrylessonsub2 (id,requestid,no,objname,jobno,lessonid,lessonname,come) values (sys_guid(),'"+requestid+"',to_number('"+no+"'),'"+name+"','"+jobno+"','"+lessonid+"','"+lessonname+"','是')";
