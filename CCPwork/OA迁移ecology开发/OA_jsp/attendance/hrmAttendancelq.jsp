...
<html>
  ...
  <body>
  <%
    List <String>lqList= new ArrayList<String>();
  ...
  <tr>
    <td align="center" height="40"><span class="STYLE2"><strong><%out.println(begindatecnd+labelService.getLabelNameByKeyId("4028834734b2525e0134b2525f120000")+enddatecnd+labelService.getLabelNameByKeyId("402883d934c01a120134c01a13560000")); %></strong></span></td><!-- 至   漏签明细 -->
  </tr>
</table>
...
<col width=30%/> <col width=20%/>  <col width=20%/> <col width=30%/>
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><%=labelService.getLabelNameByKeyId("4028834734b27dbd0134b27dbe7e0000") %></td><!-- 日期 -->
  </tr>
  <%
   for(int i=0;i<lqList.size();i++){
     String date1 = StringHelper.null2String(lqList.get(i)) ;
   %>
   <tr>
