...
<html>
  ...
  <%
	...
	//考勤记录
	sql ="select convert(varchar(10),date1,120) date2,date1,hrmid,attendance,time1,convert(varchar,cast(date1 as datetime),108) time2  from  attendance  where  hrmid='"+userCndID+"' and attendance='2' and date1 between '"+begindatecnd+"' and '"+enddatecnd+"' order by date1";
  ...
  <tr>
    <td align="center" height="40"><span class="STYLE2"><strong><%out.println(begindatecnd+labelService.getLabelNameByKeyId("4028834734b2525e0134b2525f120000")+enddatecnd+labelService.getLabelNameByKeyId("402883d934c080050134c08005df0000")); %></strong></span></td><!-- 至   早退明细 -->
  </tr>
</table>
...
<col width=20%/> <col width=20%/>  <col width=15%/><col width=15%/> <col width=30%/>
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><%=labelService.getLabelNameByKeyId("402883d934c022e30134c022e4070000") %></td><!-- 签退时间 -->
  </tr>
  <%
