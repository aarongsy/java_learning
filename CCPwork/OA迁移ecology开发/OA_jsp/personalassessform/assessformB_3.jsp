...
<span><%=firstreview1%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview1%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select1" onchange="getFirstValueB3('1','totalreview')" >
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview2%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview2%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select2" onchange="getFirstValueB3('2','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview3%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview3%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select3" onchange="getFirstValueB3('3','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview4%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview4%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select4" onchange="getFirstValueB3('4','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview5%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview5%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select5" onchange="getFirstValueB3('5','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview6%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview6%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select6" onchange="getFirstValueB3('6','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview7%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview7%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select7" onchange="getFirstValueB3('7','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview8%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview8%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select8" onchange="getFirstValueB3('8','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview9%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview9%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select9" onchange="getFirstValueB3('9','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
...
<TD noWrap class="td2"  align=center >
<span><%=firstreview10%></span>
</TD>
<TD noWrap class="td2"  align=center>
<span><%=againreview10%></span>
</TD>
<TD  noWrap class="td2"  align=center>
<select id="select10" onchange="getFirstValueB3('10','totalreview')" >
<option value="0">--请选择--</option>
<option value="1">0</option>
<option value="2">1</option>
<option value="3">2</option>
