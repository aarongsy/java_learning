 ...
 if(sublist.size()>0)
 {
	 for(int i=0;i<sublist.size();i++)
	 {
		 ...
		 else
		 {
          ...
          <TD class="td2" align=center><input type="hidden" id="<%="field_manadvice"+i%>" name="<%="field_manadvice"+i%>" value=""><span id="<%="field_manadvice"+i+"span"%>" name="<%="field_manadvice"+i+"span"%>"><%=Managermodadvice%></span></TD><!-- 总经理修改建议-->
          </TR>
<%	   }
    }
	else{%>
