...
String employno=StringHelper.null2String(request.getParameter("employno"));//工号
String planname=StringHelper.null2String(request.getParameter("planname"));//考核计划
...
String IsorNodo=StringHelper.null2String(request.getParameter("IsorNodo"));//是否会办
...
System.out.println("执行personalformA_1---------------------------------------------员工工号："+employno);

String rewardbalance=RewPunScore;//奖惩相抵分数
System.out.println("personalformA_1从数据库取出来的奖惩分数"+rewardbalance);
//System.out.println("初评或中转(A) 1："+employno +" rewardbalance:"+rewardbalance +"  startreday="+startreday+"  endreday="+endreday);
...
System.out.println("personalformA_1根据奖惩规则取得最终奖惩考分："+rpScore);
//System.out.println("初评或中转(A) 2："+employno +" rewardbalance:"+rewardbalance +"  rpScore="+rpScore);
...
System.out.println("personalformA_1最终系统评分："+SumScore);
//System.out.println("初评或中转(A) 3："+employno +" SumScore:"+SumScore );
%>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select1" onchange="getFirstValueA1('1')" >
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select2" onchange="getFirstValueA1('2')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select3" onchange="getFirstValueA1('3')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select4" onchange="getFirstValueA1('4')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select5" onchange="getFirstValueA1('5')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select6" onchange="getFirstValueA1('6')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select7" onchange="getFirstValueA1('7')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select8" onchange="getFirstValueA1('8')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select9" onchange="getFirstValueA1('9')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select10" onchange="getFirstValueA1('10')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select12" onchange="getFirstValueA1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<!--<span  id="totalfirst" ><%=totalfirst%></span>-->
	 ...
	 %>
	 <select id="select11" onchange="getTotalFirstA1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!--<option value="2" <%=selected2%>>0.5</option>-->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center ><input type="hidden" id="" style="width:20px;height:20px;text-align:center"/></TD>
<TD noWrap class="td2"  align=center ><input type="hidden" id="" style="width:20px;height:20px;text-align:center"/></TD>
