...
System.out.println("执行personalformA_end---------------------------------------------员工工号："+employno);
...
System.out.println("personalformA_end从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformA_end根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformA_end最终系统评分："+SumScore);
%>
