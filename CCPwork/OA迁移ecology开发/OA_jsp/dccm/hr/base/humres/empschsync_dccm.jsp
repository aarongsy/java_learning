...
<%
String action=request.getContextPath()+"/ServiceAction/com.eweaver.app.dccm.dmhr.base.humres.DMHR_ClassSyncAction?action=search";
%>
<%
	...
	//if(rolist.size()>0){
		pagemenustr +=  "addBtn(tb,'EmpSchePlanSync','C','application_start',function(){syncClass()});";	
	//}
         ...
         buttons:[  
             {text:"Sync",handler:function(){   
            	...
            	if(ks==""){
					...
					syncDo('<%=request.getContextPath()%>/ServiceAction/com.eweaver.app.dccm.dmhr.base.humres.DMHR_ClassSyncAction',false);
            	}
             }},
			 {text:"Sync Force",handler:function(){   
            	...
            	if(ks==""){
					...
					syncDo('<%=request.getContextPath()%>/ServiceAction/com.eweaver.app.dccm.dmhr.base.humres.DMHR_ClassSyncAction',true);
            	}
             }}
        ]  
     });  
