...
<%@ page import="com.eweaver.app.dccm.dmhr.travel.DMHR_TravelAction"%>
...
<%
	...
	if (action.equals("toSAP")){	//出差申请抛SAP
		JSONObject jsonObject = new JSONObject();		
		String requestid=StringHelper.null2String(request.getParameter("requestid"));		
		Boolean force=new Boolean(StringHelper.null2String(request.getParameter("force")));		
		DMHR_TravelAction app = new DMHR_TravelAction();
		String flag = "";
		try {
			flag = app.TravelToSAP(requestid,force);
			if ( "pass".equals(flag) ) {
