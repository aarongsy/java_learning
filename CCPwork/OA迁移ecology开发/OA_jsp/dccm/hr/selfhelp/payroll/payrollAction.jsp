			...
			try {
				...
				if( "".equals(empsapid) || "".equals(salarymon) ){
					...
					if( "I".equals(sapmsgtype) && jcostru != null ) {
						...
						String R_HOUR_ONCALL = "";
						String R_HOUR_WKDAY = "";
						String R_HOUR_RESTDAY = "";
						String R_HOUR_HOLIDAY = "";
						...
						for (int i = 0; i < jcostru.getMetaData().getFieldCount(); i++){
							...
							if ( "R_HOUR_ONCALL".equals(jcostru.getMetaData().getName(i)) ) {
								R_HOUR_ONCALL = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_HOUR_WKDAY".equals(jcostru.getMetaData().getName(i)) ) {
								R_HOUR_WKDAY = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_HOUR_RESTDAY".equals(jcostru.getMetaData().getName(i)) ) {
								R_HOUR_RESTDAY = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_HOUR_HOLIDAY".equals(jcostru.getMetaData().getName(i)) ) {
								R_HOUR_HOLIDAY = StringHelper.null2String(jcostru.getString(i));
							}							
							...
							if ( "R_BACKPAY".equals(jcostru.getMetaData().getName(i)) ) {
								R_BACKPAY = StringHelper.null2String(jcostru.getString(i));
							}							
							...
							//2018-02-07 xxy add
							if ( "R_EIS".equals(jcostru.getMetaData().getName(i)) ) {
								R_EIS = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_EISEE".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISEE = StringHelper.null2String(jcostru.getString(i));
							}							
							if ( "R_EISER".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISER = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_EISTOTCM".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISTOTCM = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_EISEEYD".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISEEYD = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_EISERYD".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISERYD = StringHelper.null2String(jcostru.getString(i));
							}
							if ( "R_EISTOTYD".equals(jcostru.getMetaData().getName(i)) ) {
								R_EISTOTYD = StringHelper.null2String(jcostru.getString(i));
							}
							
						}
						str = R_SALARY +"@@"+R_OT_ONCALL+"@@"+R_OT_WKDAY+"@@"+R_OT_RESTDAY+"@@"+R_OT_HOLIDAY
						+"@@"+R_HOUR_ONCALL+"@@"+R_HOUR_WKDAY+"@@"+R_HOUR_RESTDAY+"@@"+R_HOUR_HOLIDAY
						+"@@"+R_LEAVEPAY +"@@"+R_FIXALLOW+"@@"+R_NFIXALLOW+"@@"+R_OTHREARN+"@@"+R_BACKPAY+"@@"+R_ADVANCE
						...
						+"@@"+R_EIS+"@@"+R_EISEE+"@@"+R_EISER+"@@"+R_EISTOTCM+"@@"+R_EISEEYD+"@@"+R_EISERYD+"@@"+R_EISTOTYD;
						...
						if ( !"".equals(requestid) ) {
							...
							if (subexists==0){
								...
								buffer.append("(id,requestid,rowindex,salary,otoncall,otwkday,otrestday,otholiday,otoncallhour,otwkdayhour,otrestdayhour,otholidayhour,");
								buffer.append("leaveday,fixallow,nfixallow,othrearn,backpay,");
								...
								buffer.append("socsototyd,taxyd,taxtotyd,");
								buffer.append("eis,eisee,eiser,eistotcm,eiseeyd,eiseryd,eistotyd) values ");	
								...
								buffer.append("'").append(R_HOUR_ONCALL).append("',");
								buffer.append("'").append(R_HOUR_WKDAY).append("',");
								buffer.append("'").append(R_HOUR_RESTDAY).append("',");
								buffer.append("'").append(R_HOUR_HOLIDAY).append("',");
								...
								buffer.append("'").append(R_BACKPAY).append("',");
								...
								buffer.append("'").append(R_EIS).append("',");
								buffer.append("'").append(R_EISEE).append("',");
								buffer.append("'").append(R_EISER).append("',");
								buffer.append("'").append(R_EISTOTCM).append("',");
								buffer.append("'").append(R_EISEEYD).append("',");
								buffer.append("'").append(R_EISERYD).append("',");								
								buffer.append("'").append(R_EISTOTYD).append("')");
								...
								upsubsql = "update uf_dmhr_payrolldetail set salary='"+R_SALARY+"',otoncall='"+R_OT_ONCALL
										...
										+"',otoncallhour='"+R_HOUR_ONCALL+"',otwkdayhour='"+R_HOUR_WKDAY+"',otrestdayhour='"+R_HOUR_RESTDAY+"',otholidayhour='"+R_HOUR_HOLIDAY
										+"',leaveday='"+R_LEAVEPAY+"',fixallow='"+R_FIXALLOW+"',nfixallow='"+R_NFIXALLOW
										+"',othrearn='"+R_OTHREARN+"',backpay='"+R_BACKPAY+"',advance='"+R_ADVANCE+"',bounds='"+R_BOUNDS
										...
										+"',taxtotyd='"+R_TAXTOTYD	
										+"',eis='"+R_EIS+"',eisee='"+R_EISEE+"',eiser='"+R_EISER
										+"',eistotcm='"+R_EISTOTCM+"',eiseeyd='"+R_EISEEYD+"',eiseryd='"+R_EISERYD
										+"',eistotyd='"+R_EISTOTYD	+"' where requestid='"+requestid+"'";
								//System.out.println(upsubsql);
								baseJdbcDao.update(upsubsql);
								upsubsql = "update uf_dmhr_payroll set msgty='"+sapmsgtype+"',message='"+sapmsg+"' where requestid='"+requestid+"'";
								baseJdbcDao.update(upsubsql);
