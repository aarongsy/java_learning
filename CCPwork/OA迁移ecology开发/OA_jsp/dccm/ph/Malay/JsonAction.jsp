...
<%
	...
	if (action.equals("getData"))
	{
		...
		String TO_CURRNCY=StringHelper.null2String(request.getParameter("to_currncy"));
		if(TO_CURRNCY.equals("")||TO_CURRNCY.equals("RMB"))
		{
			TO_CURRNCY="RMB";
		}
		//创建SAP对象
	...
	if (action.equals("getDataML"))
	{
		String theDate=StringHelper.null2String(request.getParameter("theDate"));
		String currncy=StringHelper.null2String(request.getParameter("currncy"));
		String TO_CURRNCY=StringHelper.null2String(request.getParameter("to_currncy"));
		if(TO_CURRNCY.equals(""))
		{
			TO_CURRNCY="MYR";
		}
		//创建SAP对象
		SapConnector sapConnector = new SapConnector();
		String functionName = "ZOA_FI_EX_RATE_ML";
		JCoFunction function = null;
		try {
			function = SapConnector.getRfcFunction(functionName);
		} catch (Exception e) {
