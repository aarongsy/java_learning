...
<TD  noWrap class="td2"  align=center>Account</TD><!--科目-->
<!--税码改放于清帐中，会计明细中不再显示-->
...
<TD  noWrap class="td2"  align=center>Text</TD><!--文本-->
</tr>

<%
String sql2 = " select sid,accountcode,subject,taxcode,estamount,estcurrency,costcenter,receiptid,receiptitem,text1 from uf_dmsd_exfeekjpz where requestid = '"+requestid+"' and flag='"+flag+"' order by sid asc ";
//String sql2 = " select sid,accountcode,subject,taxcode,estamount,estcurrency,costcenter,receiptid,receiptitem,text1 from uf_dmsd_exfeekjpz where requestid = '"+requestid+"' and flag like '"+flag+"-%' order by sid asc ";
...
if(sublist2.size()>0)
{
	for(int k=0,sizek=sublist2.size();k<sizek;k++)
	{
		...
		int m = k;
		int no=m+1;
		String sid = StringHelper.null2String(mk.get("sid"));//序号
	...
	%>
		<TR height="30" >
		<!--<input type="checkbox" id="<%="checkbox_"+no %>" name="no">-->
