	...
	if (action.equals("upFreightclean")){//清账单
		...
		System.out.println("-------------------------------------------- requestid = " + requestid);
			...
			if(mainlist.size()>0){
				...
				//String  voucherdate = StringHelper.null2String(mm.get("voucherdate"),DateHelper.getCurrentDate()); //凭证日期	2016-03-28 xxy 注释
				String  voucherdate = StringHelper.null2String(mm.get("voucherdate")); //凭证日期	2016-03-28 xxy add
				...
				companyno=company;
				jcostruc1.setValue("BLDAT", voucherdate);//凭证日期	2016-03-28 xxy 取消注释
				//jcostruc1.setValue("BLDAT", reqdate);//凭证日期  2016-03-28 xxy 注释
				...
				System.out.println("-------------------------------------------- BLDAT = " + voucherdate);
