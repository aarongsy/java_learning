...
<%
	...
	if(list1.size()>0){
		for(int i=0;i<list1.size();i++){
			...
			String Transtype = StringHelper.null2String(map1.get("Transtype"));//付款冻结
			...
			retTable1.setValue("TRANS_TYPE", Transtype);//文本
