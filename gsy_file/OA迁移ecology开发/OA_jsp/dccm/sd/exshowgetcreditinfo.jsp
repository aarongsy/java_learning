...
<%
String sql2 = " select sid,accountcode,subject,taxcode,estamount,estcurrency,costcenter,receiptid,receiptitem,text1 from uf_dmsd_exfeekjpz where requestid = '"+requestid+"' order by sid asc";
...
if(sublist2.size()>0){
	...
	%>
		<TR height="30" >
		<TD  noWrap class="td2"  align=center><input type="checkbox" id="<%="checkbox_"+no %>" name="no"><%=sid %></TD>
