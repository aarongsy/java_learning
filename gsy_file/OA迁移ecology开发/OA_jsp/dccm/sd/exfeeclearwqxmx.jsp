...
<%
		...
		String sql="select sno,ordno,orditem,custsuppcode,custsuppflag,ledgerflag,rmbamount,fiscalyear,clearreceiptitem,clearreceiptid,surplusmoney,cleartext from uf_dmsd_exfeeqzno a where a.requestid='"+requestid+"' order by a.sno asc";
       ...
       if(sublist.size()>0){
			  ...
			  String ordno=StringHelper.null2String(mk.get("ordno"));
...
<TD noWrap><input type="hidden" id=<%="field_40285a8c6068f84c01608bc3f9986a7f_"+k%> name=<%="field_40285a8c6068f84c01608bc3f9986a7f_"+k%>  value="<%=ordno%>"   ><span style='width: 80%' id=<%="field_40285a8c6068f84c01608bc3f9986a7f_"+k+"span"%> name=<%="field_40285a8c6068f84c01608bc3f9986a7f_"+k+"span"%> ><%=ordno%></span></TD>

<TD noWrap><input type="hidden" id=<%="field_40285a8c6068f84c01608bc3f9c76a81_"+k%> name=<%="field_40285a8c6068f84c01608bc3f9c76a81_"+k%>  value="<%=orditem%>"   ><span style='width: 80%' id=<%="field_40285a8c6068f84c01608bc3f9c76a81_"+k+"span"%> name=<%="field_40285a8c6068f84c01608bc3f9c76a81_"+k+"span"%> ><%=orditem%></span></TD>
