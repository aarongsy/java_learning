...
<%
		...
		String sql="select a.sno,a.orderid,a.orditem,a.exlistid,a.feetype,a.cordate,a.k2form,a.qzsm,a.qzsl,a.payobject,a.estcurrency,a.estmoney,a.estrate,a.estamount,a.qzcurr,a.clearmoney,a.clearamount,a.buscurrencydiff,a.currencydiff,a.costcenter,a.qzrate,a.ledgersubject,a.estledgersubject,(select objname from selectitem where id=a.allocbase) as allocbase,a.invoicemoney,a.invoicenum,a.feeestid,a.ftid,a.remark from uf_dmsd_exfeeqzmx a where a.requestid='"+requestid+"' order by a.sno asc";
		...
		if(sublist.size()>0)
		{
	        for(int k=0,sizek=sublist.size();k<sizek;k++)
			{
				...
				String tsql = "select tax from uf_dmsd_taxwh where requestid='"+qzsm+"'";
				...
				String qzcurr=StringHelper.null2String(mk.get("qzcurr"));
				String qzrate=StringHelper.null2String(mk.get("qzrate"));
		...
		<TD noWrap><input type="hidden" id=<%="field_40285a8c6068f84c0160731d5b381a2b_"+k%> name=<%="field_40285a8c6068f84c0160731d5b381a2b_"+k%> value="<%=qzsm%>" ><span id=<%="field_40285a8c6068f84c0160731d5b381a2b_" +k+"span"%> name=<%="field_40285a8c6068f84c0160731d5b381a2b_" +k+"span"%>><%=tcode%></span></TD><!--清帐税码-->

		<TD noWrap><input type="hidden" id=<%="field_40285a8c6068f84c016081bef05a518c_"+k%> name=<%="field_40285a8c6068f84c016081bef05a518c_"+k%> value="<%=qzsl%>" ><span id=<%="field_40285a8c6068f84c016081bef05a518c_" +k+"span"%> name=<%="field_40285a8c6068f84c016081bef05a518c_" +k+"span"%>><%=qzsl%></span></TD><!--清帐税率-->
		...
		<TD noWrap><input type="hidden" id=<%="field_40285a8c60b5859d0160ca5d9c8a366e_"+k%> name=<%="field_40285a8c60b5859d0160ca5d9c8a366e_"+k%>  value="<%=qzcurr%>"  ><span style='width: 80%' id=<%="field_40285a8c60b5859d0160ca5d9c8a366e_"+k+"span"%> name=<%="field_40285a8c60b5859d0160ca5d9c8a366e_"+k+"span"%> ><%=qzcurr%></span></TD>
		
		<TD noWrap><input type="hidden" class="InputStyle2" name=<%="field_40285a8d4aff85d1014b0048d0490deb_"+k%>  id=<%="field_40285a8d4aff85d1014b0048d0490deb_"+k%> value="<%=clearmoney%>"  style='width: 80%' ><span id=<%="field_40285a8d4aff85d1014b0048d0490deb_"+k+"span"%> name=<%="field_40285a8d4aff85d1014b0048d0490deb_"+k+"span"%> ><%=clearmoney%></span></TD>
		
		<TD noWrap><input type="text" class="InputStyle2" name=<%="field_40285a8c5fe269cd015fe76566ab0ede_"+k%>  id=<%="field_40285a8c5fe269cd015fe76566ab0ede_"+k%>  value="<%=qzrate%>"    style='width: 80%'><span id=<%="field_40285a8c5fe269cd015fe76566ab0ede_"+k+"span"%> name=<%="field_40285a8c5fe269cd015fe76566ab0ede_"+k+"span"%> ></span></TD>
		
		<TD noWrap><input type="hidden" class="InputStyle2" name=<%="field_40285a8d4aff85d1014b0048d0700ded_"+k%>  id=<%="field_40285a8d4aff85d1014b0048d0700ded_"+k%> value="<%=clearamount%>"  style='width: 80%'  ><span id=<%="field_40285a8d4aff85d1014b0048d0700ded_"+k+"span"%> name=<%="field_40285a8d4aff85d1014b0048d0700ded_"+k+"span"%> ><%=clearamount%></span></TD>
		...
		<TD noWrap><input type="hidden" id=<%="field_40285a8d4aff85d1014b0048d1470df9_"+k%> name=<%="field_40285a8d4aff85d1014b0048d1470df9_"+k%>  value="<%=allocbase%>"  ><span style='width: 80%' id=<%="field_40285a8d4aff85d1014b0048d1470df9_"+k+"span"%> name=<%="field_40285a8d4aff85d1014b0048d1470df9_"+k+"span"%> ><%=allocbase%></span></TD>
		...
		<TD noWrap><input type="hidden" id=<%="field_40285a8d4aff85d1014b0048d1b10dff_"+k%> name=<%="field_40285a8d4aff85d1014b0048d1b10dff_"+k%> value="<%=feeestid%>" ></TD>

		<TD noWrap><input type="hidden" id=<%="field_40285a8d51c8aaea0151c8e5550e004c_"+k%> name=<%="field_40285a8d51c8aaea0151c8e5550e004c_"+k%> value="<%=remark%>" ><span style='width: 80%' id=<%="field_40285a8d51c8aaea0151c8e5550e004c_"+k+"span"%> name=<%="field_40285a8d51c8aaea0151c8e5550e004c_"+k+"span"%> ><%=remark%></span></TD>
</TR>
		<%	
