...
<body >
	...
	<table width="100%%" border="1" cellspacing="0" cellpadding="0" class="header" style="border-right:0px solid black;border-top:0px solid black;">
		...
		<tr>
			...
			<!--td colspan="2" rowspan="2"><SPAN class="STYLE3"><input type=<%=(existflag>0 ?"button":"hidden") %> name="radiobutton2" value="LeaveView" onclick="LeaveView();" /-->
			<td colspan="2" rowspan="2"><SPAN class="STYLE3"><input type="button" name="radiobutton2" value="LeaveView" onclick="LeaveView();" />
			</SPAN></td>
		</tr>
