...
<%@ page import="com.eweaver.app.dccm.dmhr.scandata.DMHR_ScanDataAction"%>
...
<%
	...
	if (action.equals("toSAP")){	//补刷卡申请抛SAP
		JSONObject jsonObject = new JSONObject();		
		String requestid=StringHelper.null2String(request.getParameter("requestid"));		
		Boolean force=new Boolean(StringHelper.null2String(request.getParameter("force")));		
		DMHR_ScanDataAction app = new DMHR_ScanDataAction();
		String flag = "";
		try {
			flag = app.ScanDataToSAP(requestid,force);
			if ( "pass".equals(flag) ) {
