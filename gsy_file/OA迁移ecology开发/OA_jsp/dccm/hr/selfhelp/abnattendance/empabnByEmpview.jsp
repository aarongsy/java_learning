...
<%	
				...
				if ( jcotable != null && jcotable.getNumRows()>0 ) {
					for (int i = 0; i < jcotable.getNumRows(); i++) {
						...
						if ( !"".equals(BEGTM) ) {
							StringBuilder sb = new StringBuilder(BEGTM);
							sb.insert(4,":");							
							sb.insert(2,":");							
							BEGTM = sb.toString();
							//System.out.println(BEGTM);	
						}							
						String ENDTM = StringHelper.null2String(jcotable.getValue("ENDTM"));
						if ( !"".equals(ENDTM) ) {
							StringBuilder sb = new StringBuilder(ENDTM);
							sb.insert(4,":");
							sb.insert(2,":");
							ENDTM = sb.toString();
...
<CAPTION><STRONG>All Clock in/out Detail </STRONG></CAPTION>
<COLGROUP>
<COL width="3%">
<COL width="3%">
<COL width="3%">
