...
function showSAPQuotainfo() {
	...
	if(flag){
		...
		Ext.Ajax.request({                                                                                                 
			 ...
			 params:{jobno:jobno,empsapid:empsapid,quotadate:quotadate,quotaids:quotaids,mode:mode},
...
<body >
	...
	<table width="100%%" border="1" cellspacing="0" cellpadding="0" class="header" style="border-right:0px solid black;border-top:0px solid black;">
		<tr>
			...
			<td><SPAN class="STYLE3"><input style="width:100px" type="text" value="<%=today %>" id="quotadate" name="quotadate" /></td>
		</tr>
		<tr>
			<td><SPAN class="STYLE4">Select Mode</SPAN></td>
			<td><SPAN class="STYLE3"><select type="text" id="mode" name="mode" value="B"><option value="B" selected >All</option><option value="A">Can Use</option></select></td>
		</tr>
		<tr>			
