...
<%@ page import="com.eweaver.app.dccm.dmhr.shiftchg.DMHR_ShifChgAction"%>
...
<%
	...
	if (action.equals("toSAP")){	//改班申请抛SAP
		JSONObject jsonObject = new JSONObject();		
		String requestid=StringHelper.null2String(request.getParameter("requestid"));		
		Boolean force=new Boolean(StringHelper.null2String(request.getParameter("force")));		
		DMHR_ShifChgAction app = new DMHR_ShifChgAction();
		String flag = "";
		try {
			flag = app.ShifChgToSAP(requestid,force);
			if ( "pass".equals(flag) ) {
