...
<%	int pagesize=20;
   ...
   // String layoutid=StringHelper.null2String(request.getParameter("formlayoutid"));
	//START 共享日程
...
if(bNewworkflow.equals("1")||editmode.equals("1")){
	...
	//保存
	if(categoryid.equals("40285a904931f62b01493c2a3998560f")&&layoutid.equals("40285a904931f62b01493c2b7de55610"))
	{
		
		pagemenustr +="addBtn(tb,'"+labelService.getLabelName("审核")+"','S','accept',function(){ alert(1)});";
	}else{
               ...
               disabledToolbar();
            	jq.ajax({
   				    ...
   				    success: function(data) {
   				    	console.info(data);
   				    	window.location.href='/app/car/create.jsp?categoryid=40285a904931f62b01493c2a3998560f&editmode=1&requestid=<%=id%>';
   				    }
   				});
             //  document.EweaverForm.submit();
