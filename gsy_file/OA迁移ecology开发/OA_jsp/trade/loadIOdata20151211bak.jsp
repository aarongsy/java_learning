...
if("zgxx".equals(action)){
	...
	String selectSql = "select * from v_uf_tr_packforlo where requestid = '"+requestid+"'";
	String countSql = "select count(*) from v_uf_tr_packforlo where requestid = '"+requestid+"'";
	...
	if(!StringHelper.isEmpty(detailid)){
		...
		if(detailList!=null&&detailList.size()>0){
			...
			String countsql = "select count(*) from v_uf_lo_dgcardetail a where isself='40288098276fc2120127704884290211' and shipout='"+param1+"' and needtype='"+param2+"' and createtype='"+param3+"' ";
