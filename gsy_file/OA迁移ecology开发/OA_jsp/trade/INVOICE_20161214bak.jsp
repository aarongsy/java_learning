...
<table width="100%%" border="0" cellpadding="0" cellspacing="0">
  ...
  %>  
  <tr>
    <td colspan="3" align="left"><span class="STYLE2"><%=i+1%>)&nbsp;</span><input class="input_txt" index="6" style="width:100%;border: 0px;border-bottom: 1px solid;font-size:21px;font-family:微软雅黑;" type="text" value="<%=stockno %>"/></td>
