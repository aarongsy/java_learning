...
String sql ="";
	...
	sql= "select a.sno,(select costname from uf_tr_fymcwhd  where requestid =a.feename)as feename,a.currency,a.amount,a.rmbamount from uf_tr_exfeedtamount a where a.requestid='"+requestid+"' order by a.sno asc";
