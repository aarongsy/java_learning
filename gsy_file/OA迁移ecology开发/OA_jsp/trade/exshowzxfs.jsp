...
String sql ="";
	...
	sql= "select sno,cabtype,cabno,wpdis,wxlevel from uf_tr_exfeedtpacking a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		String cabno=StringHelper.null2String(mk.get("cabno"));//
		String wpdis=StringHelper.null2String(mk.get("wpdis"));//
		String wxlevel=StringHelper.null2String(mk.get("wxlevel"));//
	...
	%>
		...
		<TD noWrap  class="td2"  align=center><%=wpdis %></TD>
		<TD noWrap  class="td2"  align=center><%=wxlevel %></TD>
