...
<%
	...
	if (action.equals("getData")){
		...
		String sql = "select sid,accountcode,subject,taxcode,estamount,estcurrency,costcenter,receiptid,receiptitem,text1 from uf_tr_exfeedtitem   where requestid = '"+requestid+"' and flag='"+flag+"' order by sid asc";
