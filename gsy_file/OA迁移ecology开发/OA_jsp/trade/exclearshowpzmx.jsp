...
<%
	...
	//查询数据并显示
	String selsql = "select sno,accountcode,subject,money,payitem,paydate,payfreeze,paytype,currency,paymoney,taxcaode,costcenter,receiptid,receiptitem,banktype,text1 from uf_tr_exfeeclearitem where requestid = '"+requestid+"' order by sno asc";
