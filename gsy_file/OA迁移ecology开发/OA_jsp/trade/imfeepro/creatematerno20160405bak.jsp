...
<%
	...
	String sql = "select sno,materialid,money,notesid from uf_tr_feemareceiptsub where requestid = '"+requestid+"' order by sno asc";
	...
	if(list.size()>0)
	{
		for(int i = 0;i<list.size();i++)
		{
			...
			String insql = "update uf_tr_feemareceiptsub  set sapreceiptid = '"+AC_DOC_NO+"' where requestid = '"+requestid+"' and sno = '"+sno+"'";
