...
<%
	...
	JCoTable retTable1 = function.getTableParameterList().getTable("FI_DOC_ITEMS");
	 String sql = "select sno,accountcode,subject,money,payitem,paydate,payfreeze,paytype,currency,paymoney,taxcaode,costcenter,purorderid,purorderitem,banktype,text1 from uf_tr_feereceiptinfo where requestid = '"+requestid+"' order by sno asc ";
	...
	sql = "select sno,custsuppflag,custsuppcode,ledgerflag,clearreceiptid,fiscalyear,clearreceiptitem,surplusmoney,cleartext from uf_tr_feenocleatsub where requestid = '"+requestid+"' order by sno asc";
	...
	String insql = "update uf_tr_feeclearmain  set receiptid = '"+AC_DOC_NO+"',succflag = '"+FLAG+"',errorid = '"+ERR_MSG+"' where requestid = '"+requestid+"'";
