...
<%
String sql2 = " select sid,accountcode,subject,taxcode,estamount,estcurrency,costcenter,receiptid,receiptitem,text1 from uf_tr_exfeedtitem   where requestid = '"+requestid+"' order by sid asc";
