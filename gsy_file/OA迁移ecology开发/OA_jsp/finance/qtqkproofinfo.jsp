...
<TD noWrap align="center">资产号</TD>
<TD noWrap align="center">子资产号</TD>
...
<%
	...
	if(sublist4.size() >0)
	{
		for(int j = 0;j<sublist4.size();j++)
		{
			...
			String assets = StringHelper.null2String(m4.get("assets"));
			String assetschild = StringHelper.null2String(m4.get("assetschild"));
			String expiredate = StringHelper.null2String(m4.get("expiredate"));
			String Transtype = StringHelper.null2String(m4.get("Transtype"));
...
%>
		...
		<TD  class="td2"  align=center><%=assets%></TD>
		<TD  class="td2"  align=center><%=assetschild%></TD>
		<TD  class="td2"  align=center><%=expiredate%></TD>
		<TD  class="td2"  align=center><%=Transtype%></TD>
		</TR>
	<%
	}
}else{%> 
