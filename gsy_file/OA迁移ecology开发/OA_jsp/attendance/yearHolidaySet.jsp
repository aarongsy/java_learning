...
WeaverUtil.load(function(){
  ...
  <body>
<%
	titlename=labelService.getLabelNameByKeyId("402883d934c0917e0134c0917ec30000");
%> 
<!--页面菜单结束-->
	...
	<form action="<%= request.getContextPath()%>/ServiceAction/com.eweaver.customaction.humres.AttendanceAction?action=save" name="EweaverForm" method="post">
		...
		<COLGROUP>
			...
			<tr class=Header>
				...
				<td style="text-align:center"><%=labelService.getLabelNameByKeyId("402881eb0bcd354e010bcd5a897c000d") %></td><!-- 部门 -->
				<td style="text-align:center"><%=labelService.getLabelNameByKeyId("402881e70b7728ca010b7730905d000b") %></td><!-- 姓名 -->
				<td style="text-align:center"><%=labelService.getLabelNameByKeyId("402883d934c098950134c098966d0000") %></td><!-- 年假天数 -->
