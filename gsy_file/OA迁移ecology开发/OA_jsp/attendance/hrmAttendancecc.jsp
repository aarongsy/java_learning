...
<col width=20%/> <col width=20%/>  <col width=20%/> <col width=20%/><col width=20%/>
  ...
  <%
   for(int i=0;i<outList.size();i++){
     ...
     String abd = StringHelper.null2String(m.get("actualbegindate")) ;
     String abe = StringHelper.null2String(m.get("actualenddate")) ;
     String ad = StringHelper.null2String(m.get("actualdays")) ;
   %>
  <tr>
    <td height="25" bgcolor="#FFFFFF"><%=bm%></td>
    <td bgcolor="#FFFFFF"><%=mc%></td>
    <td bgcolor="#FFFFFF"><%=abd %></td>
    <td bgcolor="#FFFFFF"><%=abe %></td>
