...
<META http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <%
    ...
    String sql="select date1,time1 from attendance where hrmid='"+userCndID+"' and attendance='2' and date1 between '"+begindatecnd+"' and '"+enddatecnd+"' order by date1";
  ...
  <tr>
    <td align="center" height="40"><span class="STYLE2"><strong><%out.println(begindatecnd+labelService.getLabelNameByKeyId("4028834734b2525e0134b2525f120000")+enddatecnd+labelService.getLabelNameByKeyId("402883d934c0201a0134c0201b7a0000")); %></strong></span></td><!-- 至   签退明细 -->
  </tr>
</table>
