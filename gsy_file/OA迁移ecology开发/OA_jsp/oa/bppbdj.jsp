...
<%
	...
	if(action.equals("getData"))
	{
		...
		if(FLAG.equals("X"))
		{
			...
			String upsql = "update uf_oa_bppbdjjd set saperrinfo ='"+ERR_MSG+"',sapreturnflag='"+FLAG+"',saplrzx='"+PRCTR+"',sapwlhms='"+MAKTX+"'";
			upsql = upsql +",newsapwlh= '"+MATNR+"',comid= '"+WERKS+"',sapcgz= '"+EKGRP+"',sapdjjd='"+MSTAE+"'";
