...
<%
	...
	if(action.equals("getData"))
	{
		...
		if(FLAG.equals("X"))
		{
			...
			String upsql = "update uf_oa_mycpkgs set saperrinfo ='"+ERR_MSG+"',sapreturnflag='"+FLAG+"',sappl='"+DISLS+"',saplrzx='"+PRCTR+"',sapmz='"+BRGEW+"',sapwlhms='"+MAKTX+"',sapsrz='"+BSTRF+"' ";
			...
			upsql = upsql +",sapmrpz='"+DISGR+"',sapmrplx='"+DISMM+"',sapmrpkzz='"+DISPO+"',sapscccdd='"+LGPRO+"',sapccdd='"+LGORT+"',sapwbcgccd='"+LGFSB+"',sapbzjg= '"+BZJG+"'";
