...
<%
	...
	if(list.size()>0){
		for(int k=0;k<list.size();k++)
		{
			...
			buf.append("<TD noWrap class=\"td2\"  align=center><input type=\"hidden\" id=\"subcate_"+k+"\" value=\""+subcate+"\"><span id=\"subcate_"+k+"span\">"+subcate+"</span></TD>");
			buf.append("<TD noWrap class=\"td2\"  align=center><input type=\"hidden\" id=\"name_"+k+"\" value=\""+goodsname+"\"><span id=\"name_"+k+"span\">"+goodsname+"</span></TD>");
