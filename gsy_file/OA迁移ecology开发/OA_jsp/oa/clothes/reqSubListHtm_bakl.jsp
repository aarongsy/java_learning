...
<%
	...
	StringBuffer buf = new StringBuffer();
		String sql = "select a.entrydate,a.nexttime,a.objname,(select objno from humres where id=a.objnum)as objno,(select objname from orgunit where id=a.reqdept)as orgid,b.subcate,b.category,b.goodname,b.specify,b.num from uf_oa_clothdetail b left join uf_oa_clothnexttime a on b.requestid=a.requestid where a.entrydate like '%"+entrydate+"%' and a.nexttime like '%"+secondtime+"%' and b.subcate='"+cate+"' and b.cate='40285a8d4d1ce05e014d4221da565b7a' and a.isleave='40288098276fc2120127704884290211'";
		if(!comp.equals(""))
		{
		...
		if(list.size()>0){
			for(int k=0;k<list.size();k++)
			{
				...
				String sql2="select columnname,requestid from uf_oa_gensplcategory where requestid='"+subcate1+"'";
				...
				sql2="select requestid,goodsname,rownum ro from uf_oa_goodsmaintain  where requestid ='"+goodname+"'";
				list2 = baseJdbc.executeSqlForList(sql2);
				//System.out.println(sql2);
				String name="";
				if(list2.size()>0){
				...
				if(cate.equals("40285a904e00d4ab014e33207a6b55ed"))
				{
