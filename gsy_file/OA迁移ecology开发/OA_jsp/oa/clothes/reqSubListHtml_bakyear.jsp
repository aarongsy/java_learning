	...
	StringBuffer buf = new StringBuffer();
		...
		if(list.size()>0){
			for(int k=0;k<list.size();k++)
			{
				...
				if(cate.equals("40285a904e00d4ab014e33207aa35606")) 
				{
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"cate_"+k+"\" value=\"工作服\"><span id=\"cate_"+k+"span\">工作服</span></TD>");
				}
				else
				{
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"cate_"+k+"\" value=\"工作服\"><span id=\"cate_"+k+"span\">工作服</span></TD>");
