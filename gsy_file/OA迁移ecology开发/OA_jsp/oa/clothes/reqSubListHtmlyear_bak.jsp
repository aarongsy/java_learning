...
<%
	...
	StringBuffer buf = new StringBuffer();
		String sql = "select a.entrydate,a.nextyear,a.objname,(select objno from humres where id=a.objnum)as objno,(select objname from orgunit where id=a.reqdept)as orgid,a.subcate,a.category,a.goodname,a.specify,a.num from uf_oa_clothnexttime a  where a.nextyear like '%"+nextyear1+"%' and instr(a.category,'"+cate+"')>0 and a.isleave='40288098276fc2120127704884290211'";
		if(!comp.equals(""))
		{
