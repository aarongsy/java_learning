...
<%
	...
	String days=StringHelper.null2String(request.getParameter("days"));
	...
	.append("(id,requestid,name,idcard,company,status,blackdate,blackreason,thetype) values").append("('").append(IDGernerator.getUnquieID()).
	...
	buffer.append("'").append(days).append("',");
