...
<%
	...
	if(action.equals("getData"))
	{
		...
		if(FLAG.equals("X"))
		{
			...
			String upsql = "update uf_oa_cpbcpxg set saperrinfo ='"+ERR_MSG+"',sapreturnflag='"+FLAG+"',sappl='"+DISLS+"',saplrzx='"+PRCTR+"',sapmz='"+BRGEW+"',sapwlhms='"+MAKTX+"',sapsrz='"+BSTRF+"' ";
			upsql = upsql +",sapcgjzdm='"+EKWSL+"',sapjz='"+NTGEW+"',sapshclsj='"+WEBAZ+"',sapzxl='"+BSTMI+"',sapzdl='"+BSTMA+"',sapcpjhsj='"+PLIFZ+"',sapjwlh='"+BISMT+"'";
			upsql = upsql +",sapmrpz='"+DISGR+"',sapmrplx='"+DISMM+"',sapmrpkzz='"+DISPO+"',comid= '"+WERKS+"',sapxszz='"+VKORG+"'";
			upsql = upsql +",sapzzsc='"+DZEIT+"',sapbom='"+ALTSL+"',sapbzjh='"+UNETO+"',sapgljh= '"+UEETO+"',sapwxzgl='"+UEETK+"'";
