...
System.out.println("执行personalformD_1---------------------------------------------员工工号："+employno);
String rewardbalance=RewPunScore;//奖惩相抵分数
System.out.println("personalformD_1从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformD_1根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformD_1最终系统评分："+SumScore);
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select1" onchange="getFirstValueD1('1')" >
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select2" onchange="getFirstValueD1('2')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select3" onchange="getFirstValueD1('3')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select4" onchange="getFirstValueD1('4')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select5" onchange="getFirstValueD1('5')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select6" onchange="getFirstValueD1('6')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select7" onchange="getFirstValueD1('7')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select8" onchange="getFirstValueD1('8')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select9" onchange="getFirstValueD1('9')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2" align=center >
	 ...
	 %>
	 <select id="select10" onchange="getFirstValueD1('10')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2" align=center >
	 ...
	 %>
	 <select id="select12" onchange="getFirstValueD1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2" align=center >
	 ...
	 %>
	 <select id="select11" onchange="getTotalFirstD1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
