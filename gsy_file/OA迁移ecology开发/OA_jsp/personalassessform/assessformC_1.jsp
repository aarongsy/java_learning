...
System.out.println("执行personalformC_1---------------------------------------------员工工号："+employno);
String rewardbalance=RewPunScore;//奖惩相抵分数
System.out.println("personalformC_1从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformC_1根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformC_1最终系统评分："+SumScore);
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select1" onchange="getFirstValueC1('1')" >
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select2" onchange="getFirstValueC1('2')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select3" onchange="getFirstValueC1('3')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select4" onchange="getFirstValueC1('4')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select5" onchange="getFirstValueC1('5')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select6" onchange="getFirstValueC1('6')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select7" onchange="getFirstValueC1('7')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select8" onchange="getFirstValueC1('8')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select9" onchange="getFirstValueC1('9')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select10" onchange="getFirstValueC1('10')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select12" onchange="getFirstValueC1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
	 ...
	 %>
	 <select id="select11" onchange="getTotalFirstC1('11')" >
		<option value="0" <%=selected12%>>--请选择--</option>
		<option value="1" <%=selected1%>>0</option>
		<!-- <option value="2" <%=selected2%>>0.5</option> -->
		<option value="3" <%=selected3%>>1</option>
