...
System.out.println("执行personalformC_2---------------------------------------------员工工号："+employno);
...
System.out.println("personalformC_2从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformC_2根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformC_2最终系统评分："+SumScore);
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select1" onchange="getFirstValueC2('1')" >
...
<TD noWrap class="td2"  align=center >15</TD>
<TD noWrap class="td2"  align=center >出色带领部属高效完成工作<br/>并能激发部属活力</TD>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select2" onchange="getFirstValueC2('2')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select3" onchange="getFirstValueC2('3')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select4" onchange="getFirstValueC2('4')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select5" onchange="getFirstValueC2('5')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select6" onchange="getFirstValueC2('6')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select7" onchange="getFirstValueC2('7')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select8" onchange="getFirstValueC2('8')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select9" onchange="getFirstValueC2('9')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
	<select id="select10" onchange="getFirstValueC2('10')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center ><input type=button value="查看" id=btnc onclick="displayC()"></TD>
<TD noWrap class="td2"  align=center >5</TD>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
	<select id="select12" onchange="getFirstValueC2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<!--<span  id="totalagain" ><%=totalagain%></span>-->
	 ...
	 %>
	<select id="select11" onchange="getTotalAgainC2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<%
if(examineperson.equals(""))//若不经过审批人
{
