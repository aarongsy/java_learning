...
if(sellist.size()>0)
{
	 ...
	 //复评分数
	 String initscore1=StringHelper.null2String(selmk.get("againreview1"));
	 String initscore2=StringHelper.null2String(selmk.get("againreview2"));
	 String initscore3=StringHelper.null2String(selmk.get("againreview3"));
	 String initscore4=StringHelper.null2String(selmk.get("againreview4"));
	 String initscore5=StringHelper.null2String(selmk.get("againreview5"));
	 String initscore6=StringHelper.null2String(selmk.get("againreview6"));
	 String initscore7=StringHelper.null2String(selmk.get("againreview7"));
	 String initscore8=StringHelper.null2String(selmk.get("againreview8"));
	 String initscore9=StringHelper.null2String(selmk.get("againreview9"));
	 String initscore10=StringHelper.null2String(selmk.get("againreview10"));
	 String initscore11=StringHelper.null2String(selmk.get("totalagain"));
	 String initscore12=StringHelper.null2String(selmk.get("againreview11"));
	 //初评分数
	 String firstscore1=StringHelper.null2String(selmk.get("firstreview1"));
	 String firstscore2=StringHelper.null2String(selmk.get("firstreview2"));
	 String firstscore3=StringHelper.null2String(selmk.get("firstreview3"));
	 String firstscore4=StringHelper.null2String(selmk.get("firstreview4"));
	 String firstscore5=StringHelper.null2String(selmk.get("firstreview5"));
	 String firstscore6=StringHelper.null2String(selmk.get("firstreview6"));
	 String firstscore7=StringHelper.null2String(selmk.get("firstreview7"));
	 String firstscore8=StringHelper.null2String(selmk.get("firstreview8"));
	 String firstscore9=StringHelper.null2String(selmk.get("firstreview9"));
	 String firstscore10=StringHelper.null2String(selmk.get("firstreview10"));
	 String firstscore11=StringHelper.null2String(selmk.get("totalfirst"));
	 String firstscore12=StringHelper.null2String(selmk.get("firstreview11"));
	 ...
	 {
		String scoresql="update uf_hr_checkperformance set againreview1="+firstscore1+",againreview2="+firstscore2+",againreview3="+firstscore3+",againreview4="+firstscore4+",againreview5="+firstscore5+",againreview6="+firstscore6+",againreview7="+firstscore7+",againreview8="+firstscore8+",againreview9="+firstscore9+",againreview10="+firstscore10+",totalagain="+firstscore11+",againreview11="+firstscore12+" where requestid='"+requestid+"'";
...
System.out.println("执行personalformA_2---------------------------------------------员工工号："+employno);
...
System.out.println("personalformA_2从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformA_2根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformA_2最终系统评分："+SumScore);
%>
...
if(sublist.size()>0)
{
    for(int k=0,sizek=sublist.size();k<sizek;k++)
	{
		Map mk = (Map)sublist.get(k);
		 ...
		 examineperson=StringHelper.null2String(mk.get("examineperson"));//审批人
		 FirstEval=StringHelper.null2String(mk.get("FirstEval"));//被考核人评语及记事
		 ReviewEval=StringHelper.null2String(mk.get("ReviewEval"));//上级主管评语及记事
		 ExamEval=StringHelper.null2String(mk.get("ExamEval"));//审批人评语及记事
		 AgainEval=StringHelper.null2String(mk.get("AgainEval"));//复评领导评语及记事
	}
}
...
<TD noWrap class="td2"  align=center>
      <%
		 if(againreview1.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview1.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview1.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview1.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview1.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview1.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview1.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview1.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview1.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview1.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview1.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select1" onchange="getFirstValueA2('1')" >
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview2.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview2.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview2.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview2.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview2.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview2.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview2.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview2.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview2.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview2.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview2.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select2" onchange="getFirstValueA2('2')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!--<option value="2" <%=selected2%>>0.5</option>-->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview3.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview3.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview3.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview3.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview3.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview3.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview3.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview3.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview3.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview3.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview3.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select3" onchange="getFirstValueA2('3')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>积极学习创新<br/>偶为公司所用</TD>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview4.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview4.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview4.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview4.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview4.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview4.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview4.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview4.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview4.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview4.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview4.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select4" onchange="getFirstValueA2('4')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TR class="tr1">
<TD noWrap class="td2"  align=center >沟通能力</TD>
<TD noWrap class="td2"  align=center >15</TD>
<TD noWrap class="td2"  align=center >善于沟通<br/>并及时解决问题</TD>
<TD noWrap class="td2"  align=center>沟通能力强<br/>人际关系融洽</TD>
<TD noWrap class="td2"  align=center >沟通能力一般</TD>
<TD noWrap class="td2"  align=center >沟通能力欠佳</TD>
<TD noWrap class="td2"  align=center >
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview5.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview5.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview5.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview5.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview5.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview5.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview5.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview5.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview5.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview5.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview5.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select5" onchange="getFirstValueA2('5')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview6.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview6.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview6.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview6.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview6.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview6.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview6.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview6.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview6.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview6.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview6.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select6" onchange="getFirstValueA2('6')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview7.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview7.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview7.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview7.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview7.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview7.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview7.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview7.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview7.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview7.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview7.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select7" onchange="getFirstValueA2('7')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview8.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview8.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview8.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview8.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview8.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview8.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview8.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview8.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview8.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview8.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview8.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select8" onchange="getFirstValueA2('8')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview9.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview9.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview9.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview9.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview9.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview9.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview9.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview9.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview9.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview9.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview9.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	 ...
	 %>
<select id="select9" onchange="getFirstValueA2('9')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview10.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview10.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview10.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview10.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview10.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview10.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview10.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview10.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview10.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview10.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview10.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	  ...
	  %>
	<select id="select10" onchange="getFirstValueA2('10')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center ><input type=button value="查看" id=btna onclick="displayA()"></TD>
<TD noWrap class="td2"  align=center >5</TD>
...
<TD noWrap class="td2"  align=center >
      <%
		 ...
		 selected11="";
		 selected12="";
		 if(againreview11.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(againreview11.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(againreview11.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(againreview11.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(againreview11.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(againreview11.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(againreview11.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(againreview11.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(againreview11.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(againreview11.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(againreview11.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	  ...
	  %>
	<select id="select12" onchange="getFirstValueA2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center >
<!--<span  id="totalagain" ><%=totalagain%></span>-->
      <%
		 selected1="";
		 selected2="";
		 selected3="";
		 ...
		 selected11="";
		 selected12="";
		 if(totalagain.equals("0"))
		 {
			 selected1="selected";
		 }
		 /*else if(totalagain.equals("0.5"))
		 {
			 selected2="selected";
		 }*/
		 else if(totalagain.equals("1"))
		 {
			 selected3="selected";
		 }
		 /*else if(totalagain.equals("1.5"))
		 {
			 selected4="selected";
		 }*/
		 else if(totalagain.equals("2"))
		 {
			 selected5="selected";
		 }
		 else if(totalagain.equals("2.5"))
		 {
			 selected6="selected";
		 }
		 else if(totalagain.equals("3"))
		 {
			 selected7="selected";
		 }
		 else if(totalagain.equals("3.5"))
		 {
			 selected8="selected";
		 }
		 else if(totalagain.equals("4"))
		 {
			 selected9="selected";
		 }
		 /*else if(totalagain.equals("4.5"))
		 {
			 selected10="selected";
		 }*/
		 else if(totalagain.equals("5"))
		 {
			 selected11="selected";
		 }
         else
	  ...
	  %>
	<select id="select11" onchange="getTotalAgainA2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<%
	...
	if(ExamEval.equals(""))//审批人未填写
	{%>
		<TR class="tr1" style="display:none">
        <TD noWrap class="td2" align=left colspan="12">评语及记事、奖惩考评(审批人员)：<span><%=ExamEval%></TD>
        </TR>
	<%}
	else//审批人有填写
	{%>
...
<TR class="tr1">
<TD noWrap class="td2" align=left colspan="12">评语及记事、奖惩考评(复评领导)：<input type="text" id="text1" value=<%=AgainEval%> style="width:70%;height:20px;text-align:left" onchange="CommentRemember('text1')"><span id="text1span"><img src=/images/base/checkinput.gif align=absMiddle></span></TD>
</TR>
