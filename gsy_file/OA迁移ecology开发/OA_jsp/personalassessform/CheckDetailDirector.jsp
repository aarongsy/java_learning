...
<TD class="td2"  align=center><input id="<%="score"+k%>" type="hidden" value="<%=score%>"><%=score%></TD><!--评分-->

<%
if(dirmodifyscore.equals(score))
{%>
<TD class="td2"  align=center><input id="<%="dirscore"+k%>" type="hidden" value="<%=dirmodifyscore%>"></TD><!--人事主管修改评分 -->
<TD class="td2"  align=center></TD><!--人事主管修改评语 -->
<%}
else
{%>
<TD class="td2"  align=center><input id="<%="dirscore"+k%>" type="hidden" value="<%=dirmodifyscore%>"><%=dirmodifyscore%></TD>
<TD class="td2"  align=center><%=dirmodifycomment%></TD>
<%}
%>
...
{%>
<TD class="td2"  align=center><input id="<%="leadscore"+k%>" type="hidden" value="<%=leadermodifyscore%>"></TD>
<TD class="td2"  align=center></TD>
<%}
else
{%>
<TD class="td2"  align=center><input id="<%="leadscore"+k%>" type="hidden" value="<%=leadermodifyscore%>"><%=leadermodifyscore%></TD><!--人事分管领导修改评分 -->
...
{%>
<TD class="td2"  align=center><input id="<%="manscore"+k%>" type="hidden" value="<%=manmodifyscore%>"></TD><!--总经理修改评分 -->
<TD class="td2"  align=center></TD><!--总经理修改评语 -->
<%}
else
{%>
<TD class="td2"  align=center><input id="<%="manscore"+k%>" type="hidden" value="<%=manmodifyscore%>"><%=manmodifyscore%></TD><!--总经理修改评分 -->
<TD class="td2"  align=center><%=manmodifycomment%></TD><!--总经理修改评语 -->
<%}
%>

<TD class="td2"  align=center><input id="<%="lastscore"+k%>" type="hidden" value="<%=lastscore%>"><span id="<%="lastscore"+k+"span"%>" name="<%="lastscore"+k+"span"%>"><%=lastscore%></span></TD><!-- 最终评分-->
</tr>
<%		
	}
}else{%> 
