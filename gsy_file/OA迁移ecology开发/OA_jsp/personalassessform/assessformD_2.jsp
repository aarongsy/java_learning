...
System.out.println("执行personalformD_2---------------------------------------------员工工号："+employno);
...
System.out.println("personalformD_2从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformD_2根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformD_2最终系统评分："+SumScore);
%>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select1" onchange="getFirstValueD2('1')" >
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select2" onchange="getFirstValueD2('2')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select3" onchange="getFirstValueD2('3')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select4" onchange="getFirstValueD2('4')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select5" onchange="getFirstValueD2('5')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select6" onchange="getFirstValueD2('6')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select7" onchange="getFirstValueD2('7')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select8" onchange="getFirstValueD2('8')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
<select id="select9" onchange="getFirstValueD2('9')" >
<option value="0" <%=selected12%>>--请选择--</option>
<option value="1" <%=selected1%>>0</option>
<!-- <option value="2" <%=selected2%>>0.5</option> -->
<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
	<select id="select10" onchange="getFirstValueD2('10')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<TD noWrap class="td2"  align=center>
	 ...
	 %>
	<select id="select12" onchange="getFirstValueD2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
...
<!--<span  id="totalagain" ><%=totalagain%></span>-->
	 ...
	 %>
	<select id="select11" onchange="getTotalAgainD2('11')" >
	<option value="0" <%=selected12%>>--请选择--</option>
	<option value="1" <%=selected1%>>0</option>
	<!-- <option value="2" <%=selected2%>>0.5</option> -->
	<option value="3" <%=selected3%>>1</option>
