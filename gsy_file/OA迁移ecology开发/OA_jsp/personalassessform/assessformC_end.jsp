...
System.out.println("执行personalformC_end---------------------------------------------员工工号："+employno);
...
System.out.println("personalformC_end从数据库取出来的奖惩分数"+rewardbalance);
...
System.out.println("personalformC_end根据奖惩规则取得最终奖惩考分："+rpScore);
...
System.out.println("personalformC_end最终系统评分："+SumScore);
%>
