...
<TD><input type=<%=( ("包车".equals(pricetypetxt) && "是".equals(ispondtxt) && !"".equals(finishpond) && "".equals(invoiceno) )?"button":"hidden") %> id="<%="field_crebudget_"+k%>" value="手工生成暂估单" onclick="singlecrebudget('<%=planno %>');"></TD>
</TR>
<%				
		}		
	} else {
