...
<form action="/ServiceAction/com.eweaver.app.exceltest.ReadBMExcel?requestid=<%=requestid%>" name="form1" id="form1" method="post" enctype="multipart/form-data">
        <table style="border:0">
				<colgroup>
					<col width="100%">
				</colgroup>
            <TR><TD colspan=3 align="center"><input type="file" name="path" /><A href="javascript:importRecords()"><FONT color=#ff0000>Excel导入询价明细</FONT></A><input type="hidden" id="throwstr" value="<%=throwstr%>"></TD><TR>
	    </table>
        </form>
