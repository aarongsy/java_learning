...
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;预估门点柜量&nbsp;&nbsp;</TD>
<TD  noWrap class="td2"  align=center colspan=12>&nbsp;&nbsp;USD费用(A)&nbsp;&nbsp;</TD>
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;备注&nbsp;&nbsp;</TD>
</TR>
<TR height="25"  class="title">
...
String sql ="";
	...
	sql= "select sno,gx,isdanger,dengerllv,hxarea,hx,qygang,mdgang,equair,pro,gl,hyfee,gxfee,baf,yas,gbf,caf,ebs,cic,ens,ams,rcs,pss,days21,days30,days45,days60,shipcom,shipdate,remark from uf_tr_baojiachild a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	...
	%>
		...
		<TD noWrap  class="td2"  align=center>&nbsp;&nbsp;<input type="text" id="<%="shipcom_"+k%>" value="<%=remark%>" onblur="changeshipcom('<%=sno%>','<%=k%>')">&nbsp;&nbsp;</TD>
