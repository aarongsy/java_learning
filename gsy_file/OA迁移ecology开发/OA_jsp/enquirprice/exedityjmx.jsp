...
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;&nbsp;&nbsp;</TD>
...
String sql ="";
	...
	sql= "select sno,gx,isdanger,dengerllv,hxarea,hx,qygang,mdgang,equair,pro,hyfee,gxfee,baf,yas,gbf,caf,ebs,cic,ens,ams,rcs,pss,days21,days30,days45,days60,shipcom,shipdate,bjsum,gl,yujiprice from uf_tr_yijiasub a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	...
	%>
		...
		<TD noWrap  class="td2"  align=center ><A href="javascript:deleterow('<%=sno%>')">删除</A></TD>
	...
	<TR><TD class="td2" colspan="27">没有信息</TD></TR>
<%} %>
</table>
</div>
