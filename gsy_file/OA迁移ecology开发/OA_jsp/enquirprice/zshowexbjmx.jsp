...
<TD  noWrap class="td2"  align=center rowspan=2>&nbsp;&nbsp;备注&nbsp;&nbsp;<%=hl %></TD>
</TR>
<TR height="25"  class="title">
...
if(sublist.size()>0){
	...
	<TR><TD class="td2" colspan="37">没有信息</TD></TR>
<%} %>
</table>
</div>
