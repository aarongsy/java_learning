...
String sql ="";
	...
	sql= "select a.sno,a.lineno,a.linename,a.linetype,a.trantype,a.hxarea,a.qygang,a.gycity,a.mdgang,a.mdcity,a.vehicle,a.gx,a.danger,a.dangerlv,a.pritype,a.stone,a.etone,a.requir,a.gxfee,a.gl,a.sl,a.timee,a.price,a.baojia,a.curr,a.boat,a.remark,(select objno from humres where id=a.supcode) supcode,(select objname from humres where id=a.supcode) supname,dense_rank() over(partition by a.linename,a.mdgang,gx,danger,requir order by total) dense_rank,a.hyfee,a.jrfee,a.total from uf_tr_bijiasubnm a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	...
	<TR><TD class="td2" colspan="21">没有信息</TD></TR>
<%} %>
</table>
</div>
