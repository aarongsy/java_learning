...
String sql ="";
	...
	sql= "select sno,lineno,linename,linetype,trantype,hxarea,qygang,gycity,mdgang,mdcity,vehicle,gx,danger,dangerlv,pritype,stone,etone,requir,gxfee,gl,sl,timee,price,baojia,curr,boat,zdprice,xjrequestid,bijsubid from uf_lo_yjbjsub a where a.requestid='"+requestid+"' order by a.sno asc";
...
if(sublist.size()>0){
	...
	<TR><TD class="td2" colspan="17">没有信息</TD></TR>
<%} %>
</table>
</div>
