...
String sql ="";
	...
	sql= "select sno,lineno,linename,linetype,trantype,hxarea,qygang,gycity,mdgang,mdcity,gx,danger,dangerlv,requir,gxfee,gl,sl,timee,price,baojia,curr,boat,zdprice,xjrequestid,bijsubid from uf_lo_yjbjsub a where a.requestid='"+requestid+"' order by a.sno asc";
