...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		Double sum=(Double.valueOf(hyfee)+ Double.valueOf(gxfee)+Double.valueOf(baf)+Double.valueOf(yas)+Double.valueOf(gbf)+Double.valueOf(caf)+Double.valueOf(ebs)+Double.valueOf(cic)+Double.valueOf(ens)+Double.valueOf(ams)+Double.valueOf(rcs)+Double.valueOf(pss)+Double.valueOf(days21)+Double.valueOf(days30)+Double.valueOf(days45)+Double.valueOf(days60));
		Double sumold=0.00;
		...
		if(sublist2.size()>0)
		{
			...
			String hyfee1=StringHelper.null2String(mk.get("hyfee"));
			String gxfee1=StringHelper.null2String(mk.get("gxfee"));
			String baf1=StringHelper.null2String(mk.get("baf"));
			String yas1=StringHelper.null2String(mk.get("yas"));
			String gbf1=StringHelper.null2String(mk.get("gbf"));
			String caf1=StringHelper.null2String(mk.get("caf"));
			String ebs1=StringHelper.null2String(mk.get("ebs"));
			String cic1=StringHelper.null2String(mk.get("cic"));
			String ens1=StringHelper.null2String(mk.get("ens"));
			String ams1=StringHelper.null2String(mk.get("ams"));
			String rcs1=StringHelper.null2String(mk.get("rcs"));
			String pss1=StringHelper.null2String(mk.get("pss"));
			String d1=StringHelper.null2String(mk.get("days21"));
			String d2=StringHelper.null2String(mk.get("days30"));
			String d3=StringHelper.null2String(mk.get("days45"));
			String d4=StringHelper.null2String(mk.get("days60"));
		...
		String insql = "insert into uf_tr_bijiadetail   (id,requestid,sno,gx,isdanger,dengerllv,hxarea,hx,qygang,mdgang,equair,pro,hyfee,gxfee,baf,yas,gbf,caf,ebs,cic,ens,ams,rcs,pss,days21,days30,days45,days60,shipcom,shipdate,supcode,supname,gsum,gl,addusd,addfl,xjrequestid,bjid)values('"+IDGernerator.getUnquieID()+"','"+requestid+"',"+no+",'"+gx+"','"+isdanger+"','"+dengerllv+"','"+hxarea+"','"+hx+"','"+qygang+"','"+mdgang+"','"+equair+"','"+pro+"',"+hyfee+","+gxfee+","+baf+","+yas+","+gbf+","+caf+","+ebs+","+cic+","+ens+","+ams+","+rcs+","+pss+","+days21+","+days30+","+days45+","+days60+",'"+shipcom+"','"+shipdate+"','"+bjman+"','"+objname+"',"+sum+","+gl+","+addusd+","+addfl+",'"+xjno+"','"+id+"')";
