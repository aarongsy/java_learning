...
System.out.println("部门培训实施：");
	...
	if(list.size()>0)
	{
		...
		{
			String delsql = "delete from  uf_hr_deptimplesub where requestid='"+requestid+"' and (no='"+(i+1)+"' or no>'"+changdu+"' or no is null)";
			...
			String insql="insert into uf_hr_deptimplesub (id,requestid,no,jobno,objname,reqdept,duixiang1,humtype,title,hours,skfs1,qtskfs1,khfs1,qtkhfs1) values ('"+IDGernerator.getUnquieID()+"','"+requestid+"','"+(i+1)+"','"+objno+"','"+renyuan+"','"+orgid+"','"+duixiang+"','40285a90490d16a301491ca714102ae9','"+keti+"','"+keshi+"','"+skfs+"','"+qtskfs+"','"+khfs+"','"+qtkhfs+"')";      
