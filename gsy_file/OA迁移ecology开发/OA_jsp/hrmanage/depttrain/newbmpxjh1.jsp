...
<%
	String sql="select a.*,(select objno from humres where id=a.jsno) as jsno1 from uf_hr_bmpxjhdetail a where a.requestid='"+requestid+"' order by a.no asc";
...
<TR id=oTR40285a8d59a162b00159a52e91cf0327 class=DataLight><!-- 明细表ID，请勿删除。-->
	...
	<TD noWrap>   
		<input type="hidden" id="<%="field_40285a8d59a5891b0159a5b7ce190188_"+i%>" name="<%="field_40285a8d59a5891b0159a5b7ce190188_"+i%>" value="40288098276fc2120127704884290210" onblur="changeisvalid('<%=no%>','<%=i%>')">
