...
<%
	...
	if(list.size()>0){
		for(int k=0;k<list.size();k++)
		{
			...
			String fankui =StringHelper.null2String(map.get(""));//培训实施反馈
			...
			if(state2.equals("新增")||(state2.equals("修改")&&state.equals("原始")))
			{
				%>
				<TR height="16px">
					...
					<TD noWrap align=center><%=fankui%></TD>
