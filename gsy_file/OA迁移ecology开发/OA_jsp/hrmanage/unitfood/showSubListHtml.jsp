...
if(sublist.size()>0){
	for(int k=0,sizek=sublist.size();k<sizek;k++){
		...
		if(nodeshow.equals("edit")){
			...
			{
				if(breakfast.equals("")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"breakfast_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"breakfast_"+k+"\" id=\"breakfast_"+k+"\"><option value=\"\" selected></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
				}
				else if(breakfast.equals("40285a90495b4eb001496408814f5996"))
				{
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"breakfast_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"breakfast_"+k+"\" id=\"breakfast_"+k+"\"><option value=\"\" ></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" selected>送餐</option></select></TD>");
				}
				else buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"breakfast_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"breakfast_"+k+"\" id=\"breakfast_"+k+"\"><option value=\"\" ></option><option value=\"40285a90495b4eb001496408814f5995\" selected>订餐</option> <option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
			}
			else
			{
				if(breakfast.equals("")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"breakfast_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"breakfast_"+k+"\" id=\"breakfast_"+k+"\"><option value=\"\" selected></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option></select></TD>");
				}else buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"breakfast_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"breakfast_"+k+"\" id=\"breakfast_"+k+"\"><option value=\"\" ></option><option value=\"40285a90495b4eb001496408814f5995\" selected>订餐</option></select></TD>");
			}
			//}else 
		...
		if(nodeshow.equals("edit")){
			//if(day.getTime()>=today.getTime()){
				if(lunch.equals("")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"lunch_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"lunch_"+k+"\" id=\"lunch_"+k +"\"><option value=\"\" selected ></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
				}else if(lunch.equals("40285a90495b4eb001496408814f5995")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"lunch_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"lunch_"+k+"\" id=\"lunch_"+k +"\"><option value=\"\"  ></option><option value=\"40285a90495b4eb001496408814f5995\" selected>订餐</option><option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
				}else buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"lunch_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"lunch_"+k+"\" id=\"lunch_"+k +"\"><option value=\"\"  ></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" selected>送餐</option></select></TD>");
			//}else buf.append("<TD class=\"td2\"  align=center>"+l+"</TD>");
		}else buf.append("<TD class=\"td2\"  align=center>"+l+"</TD>");
		if(nodeshow.equals("edit")){
			//if(day.getTime()>=today.getTime()){
				if(dinner.equals("")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"dinner_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"dinner_"+k+"\" id=\"dinner_"+k+"\"><option value=\"\" selected></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
				}else if(dinner.equals("40285a90495b4eb001496408814f5995")){
					buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"dinner_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"dinner_"+k+"\" id=\"dinner_"+k+"\"><option value=\"\"></option><option value=\"40285a90495b4eb001496408814f5995\" selected>订餐</option><option value=\"40285a90495b4eb001496408814f5996\" >送餐</option></select></TD>");
				}else buf.append("<TD class=\"td2\"  align=center><input type=\"hidden\" id=\"dinner_"+k+"check\" value=\"\" ><select class=\"InputStyle6\" name=\"dinner_"+k+"\" id=\"dinner_"+k+"\"><option value=\"\"></option><option value=\"40285a90495b4eb001496408814f5995\" >订餐</option><option value=\"40285a90495b4eb001496408814f5996\" selected>送餐</option></select></TD>");
