	...
	for(int i=0;i<hnames.length;i++){
		...
		if(list.size()>0){
			...
			for(int m=0;m<days;m++){
				...
				if(nowday.equals("2017-9-30")&&Integer.parseInt(strhour)>=16)
				{
					
					if("2017-10-01,2017-10-02,2017-10-03,2017-10-04,2017-10-05,2017-10-06,2017-10-07,2017-10-08".indexOf(thedate)!=-1)
					{
						zcshow="disabled";
						wucshow="disabled";
						wancshow="disabled";
				...
				if("2017-10-1,2017-10-2,2017-10-3,2017-10-4,2017-10-5,2017-10-6,2017-10-7,2017-10-8".indexOf(nowday)!=-1)
				{
				...
				System.out.println( "nowday="+nowday +" strhour="+strhour +" nowday.equals(2018-02-13)="+(nowday.equals("2018-02-13"))  + " Integer.parseInt(strhour)>=12 "+ (Integer.parseInt(strhour)>=12));
				if(nowday.equals("2018-2-13") && Integer.parseInt(strhour)>=12)
				{					
					if("2018-02-14,2018-02-15,2018-02-16,2018-02-17,2018-02-18,2018-02-19,2018-02-20,2018-02-21".indexOf(thedate)!=-1)
					{
						zcshow="disabled";
						wucshow="disabled";
						wancshow="disabled";
				...
				if("2018-2-15,2018-2-16,2018-2-17,2018-2-18,2018-2-19,2018-2-20,2018-2-21".indexOf(nowday)!=-1)
				{					
					if("2018-02-15,2018-02-16,2018-02-17,2018-02-18,2018-02-19,2018-02-20,2018-02-21".indexOf(thedate)!=-1)
					{
						zcshow="disabled";
						wucshow="disabled";
						wancshow="disabled";
