...
<%
	...
	//	String  num= StringHelper.null2String(request.getParameter("num"));//次数
		...
		if(list.size()>0){
			...
			getsql =  "select sapid,Money from uf_hr_festivalcashsub  where requestid = '"+requestid+"' and no>=0 and no<=500 and money>0";
			...
			if(getlist.size()>0){
				for(int i=0;i<getlist.size();i++){
					...
					if(sapid.indexOf("00003280")== -1 && sapid.indexOf("00003258")== -1 && sapid.indexOf("00003173")== -1 && sapid.indexOf("00003482")== -1)
					{
						retTable.appendRow();
