...
String url = "/ReportServer?reportlet=/app/hrmanage/contract/contractlist.cpt"; 	//合同套打清单导出
//人事业务人员（合同）角色：	40285a9049f5c9900149f91201c0002a		人事组织修改角色		40285a904abeeb0e014ac37afe343d02
...
<body >
	...
	<div>
		<div align="center"><SPAN class="STYLE10">人事套打报表</SPAN></div>
	</div>
	...
	<table width="100%%" border="1" cellspacing="0" cellpadding="0" class="header" style="border-right:0px solid black;border-top:0px solid black;">
		<tr>
			...
			<td colspan="2" rowspan="2"><SPAN class="STYLE3"><input type=<%=(existflag>0 ?"button":"hidden") %> name="radiobutton2" value="员工人事合同清单导出word套打用" onclick="ViewContractReport();" /></SPAN></td>
		</tr>
