...
<%
	...
	String mark="1";//标识
	//点击按钮前先清空原来的出入厂记录
	String upsql="update uf_oa_forwarderlist set infactorytime='',outfactorytime='' where requestid='"+requestid+"' and identify='"+idcard+"' and ddate='"+ddate+"' and stime='"+dstart+"' and etime='"+dend+"'";
	...
	if(list.size()>0)
	{
			...
			for(int i=0;i<list.size();i++)
			{
                ...
                //System.out.println("0000000000000--------------------------"+idcard);
				...
				if(repeat.equals("")&&inout.equals("进"))
				{
					...
					{
						String upsql1="update uf_oa_forwarderlist set infactorytime='"+cardtime+"' where requestid='"+requestid+"' and identify='"+idcard+"' and ddate='"+ddate+"' and stime='"+dstart+"' and etime='"+dend+"'";
				...
				{
					String upsql2="update uf_oa_forwarderlist set outfactorytime='"+cardtime+"' where requestid='"+requestid+"' and identify='"+idcard+"' and ddate='"+ddate+"' and stime='"+dstart+"' and etime='"+dend+"'";
